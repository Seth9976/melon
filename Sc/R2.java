...
public final class r2 extends i implements n {
    ...
    public r2(S2 s20, Continuation continuation0) {
        this.w = s20;
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.r) {
            case 0: {
                d5.n.D(object0);
                this.r = 1;
                H h1 = SmartPlaylistServerSyncPreferencesRepository.INSTANCE.clearAndIncrementNotSentEditCount("enqueue SyncByAppDataFromUserSelectPopup", this);
                if(h1 != a0) {
                    h1 = h0;
                }
                return h1 == a0 ? a0 : h0;
