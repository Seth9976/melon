...
public final class s1 extends i implements n {
    ...
    public final q1 W;
    public final l1 X;
    public final ListKeepOption Y;
    public int Z;
    public Mutex r;
    public Object w;

    public s1(Mutex mutex0, Continuation continuation0, Mutex mutex1, String s, DevLog devLog0, S2 s20, q1 q10, l1 l10, ListKeepOption listKeepOption0) {
        this.M = mutex0;
        this.N = mutex1;
        this.S = s;
        this.T = devLog0;
        ...
        this.W = q10;
        this.X = l10;
        this.Y = listKeepOption0;
        super(2, continuation0);
    }

    @Override  // oe.a
    public final Continuation create(Object object0, Continuation continuation0) {
        return new s1(this.M, continuation0, this.N, this.S, this.T, this.V, this.W, this.X, this.Y);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(v) {
            ...
            case 1: {
                ...
                label_34:
                    ...
                    try {
                        s20.r();
                        u1 u10 = new u1(s20, l10, this.Y, null);
                        this.r = mutex1;
                        this.w = object3;
                        this.B = v2;
                        this.D = 0;
                        ...
                        this.Z = 0;
                        this.E = 2;
                        object4 = BuildersKt.withContext(Dispatchers.getIO(), u10, this);
                    }
                    catch(Exception exception0) {
                        object1 = object3;
                        v1 = v3;
                        a1 = S2.f(s20, q10, exception0);
                        goto label_128;
                    }
                }
        ...
        try {
            ...
            this.Z = v4;
            this.E = 3;
            object2 = S2.e(s20, q10, l10, ((PlaylistsSmartEditRes)object4), this);
        }
        catch(Exception exception0) {
            object1 = object5;
            v1 = v5;
