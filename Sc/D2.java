...
public final class d2 extends i implements n {
    public int B;
    public int D;
    public int E;
    public int G;
    ...
    public d2(Mutex mutex0, Continuation continuation0, Mutex mutex1, String s, DevLog devLog0, S2 s20, E1 e10, l1 l10, ArrayList arrayList0) {
        this.M = mutex0;
        this.N = mutex1;
        this.S = s;
        this.T = devLog0;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new d2(this.M, continuation0, this.N, this.S, this.T, this.V, this.W, this.X, this.Y);
    }

    @Override  // we.n
    public final Object invoke(Object object0, Object object1) {
        return ((d2)this.create(((CoroutineScope)object0), ((Continuation)object1))).invokeSuspend(H.a);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(v) {
            ...
            case 1: {
                ...
                label_34:
                    ...
                    try {
                        s20.r();
                        f2 f20 = new f2(s20, l10, this.Y, null);
                        this.r = mutex1;
                        this.w = object3;
                        this.B = v2;
                        this.D = 0;
                        ...
                        this.Z = 0;
                        this.E = 2;
                        object4 = BuildersKt.withContext(Dispatchers.getIO(), f20, this);
                    }
                    catch(Exception exception0) {
                        object1 = object3;
                        v1 = v3;
                        a1 = S2.f(s20, e10, exception0);
                        goto label_128;
                    }
                }
        ...
        try {
            ...
            this.Z = v4;
            this.E = 3;
            object2 = S2.e(s20, e10, l10, ((PlaylistsSmartEditRes)object4), this);
        }
        catch(Exception exception0) {
            object1 = object5;
            v1 = v5;
