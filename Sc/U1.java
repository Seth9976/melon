...
import com.iloen.melon.net.mcp.request.PlaylistsSmartDeleteExistingReq;
...
public final class u1 extends i implements n {
    ...
    public final S2 E;
    public final l1 G;
    public final ListKeepOption I;
    public RequestFuture r;
    public Context w;

    public u1(S2 s20, l1 l10, ListKeepOption listKeepOption0, Continuation continuation0) {
        this.E = s20;
        this.G = l10;
        this.I = listKeepOption0;
        super(2, continuation0);
    }

    @Override  // oe.a
    public final Continuation create(Object object0, Continuation continuation0) {
        return new u1(this.E, this.G, this.I, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        HttpResponse httpResponse0 = RequestBuilder.newInstance(new PlaylistsSmartDeleteExistingReq(context0, s1, ((Number)object0).longValue(), MapperKt.asIsDeleteExisting(this.I))).tag("SmartServerSyncManagerImpl").listener(requestFuture1).errorListener(requestFuture1).requestSync(requestFuture1);
