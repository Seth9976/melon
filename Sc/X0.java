...
public final class x0 extends i implements n {
    ...
    public x0(P0 p00, Continuation continuation0) {
        this.M = p00;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new x0(this.M, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.I) {
            case 0: {
                ...
                p00 = this.M;
                Mutex mutex0 = p00.j;
                LogU.debug$default(MutexLockUtil.INSTANCE.getLog(), o.j(mutex0.hashCode(), "Lock[", "]  try : smart_onNeedUpdateAllToServer"), null, false, 6, null);
                DevLog devLog0 = DevLog.Companion.get("MutexLockUtil");
                Y.u("Lock[", mutex0.hashCode(), "]  try : smart_onNeedUpdateAllToServer", devLog0);
                this.r = mutex0;
                this.w = "smart_onNeedUpdateAllToServer";
                this.B = p00;
                this.D = devLog0;
                this.E = "";
                this.G = mutex0;
                ...
                s = "smart_onNeedUpdateAllToServer";
                devLog1 = devLog0;
                mutex1 = mutex0;
                s1 = "";
                mutex2 = mutex1;
        ...
        try {
            ...
            if(!p00.k) {
                throw new IllegalArgumentException("onNeedUpdateAllToServer - not restored");
            }
            h1 h10 = p00.Q();
            ((S2)p00.e).G(h10, true);
        }
