...
import com.iloen.melon.net.mcp.request.PlaylistsSmartTracksAddReq;
...
public final class j2 extends i implements n {
    ...
    public j2(S2 s20, l1 l10, int v, ArrayList arrayList0, ArrayList arrayList1, String s, Continuation continuation0) {
        this.E = s20;
        this.G = l10;
        this.I = v;
        this.M = arrayList0;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new j2(this.E, this.G, this.I, this.M, this.N, this.S, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        HttpResponse httpResponse0 = RequestBuilder.newInstance(new PlaylistsSmartTracksAddReq(context1, s1, ((Number)object0).longValue(), this.I, this.M, this.N)).tag(this.S).listener(requestFuture1).errorListener(requestFuture1).requestSync(requestFuture1);
