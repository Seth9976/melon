...
import com.iloen.melon.net.mcp.request.PlaylistsSmartAddOptionReq;
...
public final class p1 extends i implements n {
    ...
    public final S2 E;
    public final l1 G;
    public final AddPosition I;
    public RequestFuture r;
    public Context w;

    public p1(S2 s20, l1 l10, AddPosition addPosition0, Continuation continuation0) {
        this.E = s20;
        this.G = l10;
        this.I = addPosition0;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new p1(this.E, this.G, this.I, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        HttpResponse httpResponse0 = RequestBuilder.newInstance(new PlaylistsSmartAddOptionReq(context0, s1, ((Number)object0).longValue(), MapperKt.asAddOptionServer(this.I))).tag("SmartServerSyncManagerImpl").listener(requestFuture1).errorListener(requestFuture1).requestSync(requestFuture1);
