...
public final class o implements we.o {
    ...
    public o(k k0, x x0, int v, int v1) {
        this.a = v1;
        this.b = k0;
        this.c = x0;
        this.d = v;
    ...
    public final Object invoke(Object object0, Object object1, Object object2) {
        if(this.a != 0) {
            ...
            r0.q q0 = androidx.compose.foundation.q.l(((r0.q)object0), m0, null, true, null, new i(0), new n(((h)object3), this.b, this.c, this.d, 1));
            ((p)(((l)object1))).p(false);
            return q0;
        }
        ((Number)object2).intValue();
        ...
        r0.q q1 = androidx.compose.foundation.q.l(((r0.q)object0), m1, null, true, null, new i(0), new n(((h)object4), this.b, this.c, this.d, 0));
        ((p)(((l)object1))).p(false);
        return q1;
    }
}
