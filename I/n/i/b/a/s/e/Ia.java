...
public final class ia extends ga {
    ...
    public ia(long v, boolean z, boolean z1, boolean z2, boolean z3, long v1, long v2, List list0, boolean z4, long v3, int v4, int v5, int v6) {
        this.a = v;
        this.b = z;
        this.c = z1;
        this.d = z2;
    ...
    public ia(Parcel parcel0) {
        ...
        for(int v1 = 0; v1 < v; ++v1) {
            arrayList0.add(new u4(parcel0.readInt(), parcel0.readLong(), parcel0.readLong()));
        }
    ...
    public final void writeToParcel(Parcel parcel0, int v) {
        ...
        for(int v2 = 0; v2 < v1; ++v2) {
            u4 u40 = (u4)list0.get(v2);
            parcel0.writeInt(u40.a);
            parcel0.writeLong(u40.b);
            parcel0.writeLong(u40.c);
        }
