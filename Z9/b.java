...
public final class b extends i implements n {
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        HttpResponse httpResponse0 = RequestBuilder.newInstance(new InformExcArtistReq(Y.a(MelonAppBase.Companion), this.r)).tag("ExcludedArtistSyncExecutor").listener(requestFuture0).errorListener(requestFuture0).requestSync(requestFuture0);
        q.e(httpResponse0, "null cannot be cast to non-null type com.iloen.melon.net.v4x.response.InformExcArtistRes");
        return (InformExcArtistRes)httpResponse0;
    }
}
