...
public final class f0 extends i implements n {
    ...
    public f0(GlanceAppWidgetReceiver glanceAppWidgetReceiver0, Context context0, int v, String s, Continuation continuation0) {
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        Continuation continuation1 = new f0(this.B, this.D, this.E, this.G, continuation0);
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.r) {
            case 0: {
                ...
                t0.getClass();
                f f0 = new f(this.E);
                S s0 = new S(this.G, null, 1);
                Q q0 = new Q(this.D, f0, t0, null, s0, null);
                H h1 = t0.a.a(q0, this);
                if(h1 != a0) {
                    h1 = h0;
                }
