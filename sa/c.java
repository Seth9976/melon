...
public final class c {
    ...
    public final Serializable a(String s, oe.c c0) {
        ...
        if(((ApiResult)object0) instanceof Success) {
            return (SearchInformSongWithPianoforteRes)((Success)(((ApiResult)object0))).getData();
        }
    ...
    public final Serializable b(oe.c c0) {
        ...
        if(((ApiResult)object0) instanceof Success) {
            return (SearchSettingSongWithPianoforteRes)((Success)(((ApiResult)object0))).getData();
        }
        if(!(((ApiResult)object0) instanceof Failure)) {
            throw new M3();  // 初始化器: Ljava/lang/RuntimeException;-><init>()V
        }
