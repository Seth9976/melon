...
public abstract class v extends C0 implements b {
    ...
    public final void onAttach(Activity activity0) {
        ...
        n.n(this.g == null || i.b(this.g) == activity0, "onAttach called multiple times with different Context! Hilt Fragments should not be retained.", new Object[0]);
        this.m();
        if(!this.k) {
            this.k = true;
            wd.c c0 = (wd.c)this.generatedComponent();
            wd.b b0 = (wd.b)this;
            c0.getClass();
        }
    }
