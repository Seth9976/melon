...
public abstract class CertificateChainCleaner {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final CertificateChainCleaner get(@NotNull X509TrustManager x509TrustManager0) {
            q.g(x509TrustManager0, "trustManager");
            return Platform.Companion.get().buildCertificateChainCleaner(x509TrustManager0);
        }

        @NotNull
        public final CertificateChainCleaner get(@NotNull X509Certificate[] arr_x509Certificate) {
    ...
    @NotNull
    public abstract List clean(@NotNull List arg1, @NotNull String arg2);
}
