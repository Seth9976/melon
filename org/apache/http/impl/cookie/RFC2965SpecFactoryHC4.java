...
public class RFC2965SpecFactoryHC4 implements CookieSpecFactory, CookieSpecProvider {
    ...
    public RFC2965SpecFactoryHC4(String[] arr_s, boolean z) {
    ...
    public CookieSpec newInstance(HttpParams httpParams0) {
        if(httpParams0 != null) {
            ...
            return collection0 == null ? new RFC2965SpecHC4(null, httpParams0.getBooleanParameter("http.protocol.single-cookie-header", false)) : new RFC2965SpecHC4(((String[])collection0.toArray(new String[collection0.size()])), httpParams0.getBooleanParameter("http.protocol.single-cookie-header", false));
        }
