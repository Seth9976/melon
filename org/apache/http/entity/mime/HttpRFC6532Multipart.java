...
class HttpRFC6532Multipart extends AbstractMultipartForm {
    ...
    public HttpRFC6532Multipart(String s, Charset charset0, String s1, List list0) {
        super(s, charset0, s1);
        this.parts = list0;
    }
    ...
    public void formatMultipartHeader(FormBodyPart formBodyPart0, OutputStream outputStream0) {
        for(Object object0: formBodyPart0.getHeader()) {
            AbstractMultipartForm.writeField(((MinimalField)object0), MIME.UTF8_CHARSET, outputStream0);
        }
    }
