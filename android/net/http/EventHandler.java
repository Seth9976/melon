...
public interface EventHandler {
    ...
    void certificate(SslCertificate arg1);

    void data(byte[] arg1, int arg2);

    void endData();

    void error(int arg1, String arg2);

    boolean handleSslErrorRequest(SslError arg1);

    void headers(Headers arg1);

    void status(int arg1, int arg2, int arg3, String arg4);
}
