...
public final class t2 extends Z3 {
    ...
    public t2(ActionKind actionKind0, String s, String s1, String s2, Meta meta0) {
        this.a = actionKind0;
        this.b = s;
        this.c = s1;
        this.d = s2;
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.a != ((t2)object0).a) {
            return false;
        }
        if(!q.b(this.b, ((t2)object0).b)) {
            return false;
        }
        if(!q.b(this.c, ((t2)object0).c)) {
            return false;
        }
        return q.b(this.d, ((t2)object0).d) ? q.b(this.e, ((t2)object0).e) : false;
    }
