...
public final class m0 extends i implements n {
    public final ListKeepOption B;
    public int r;
    public final b w;

    public m0(b b0, ListKeepOption listKeepOption0, Continuation continuation0) {
        this.w = b0;
        this.B = listKeepOption0;
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.r) {
            ...
            label_19:
                this.r = 3;
                ((P0)object0).getClass();
                y y0 = new y(((P0)object0), this.B, null);
                H h1 = BuildersKt.withContext(NonCancellable.INSTANCE, y0, this);
                if(h1 != a0) {
                    h1 = h0;
                }
                if(h1 == a0) {
