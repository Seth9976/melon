...
public final class k extends i implements n {
    ...
    public k(Context context0, b0 b00, Content flexibleRes$RESPONSE$Flexible$Content0, Continuation continuation0) {
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new k(this.w, this.B, this.r, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        d5.n.D(object0);
        String s = this.r.getEffectImgUrl();
        if(s != null) {
            Glide.with(this.w).asDrawable().load(s).into(new b(this.B, 2));
        }
        return H.a;
    }
}
