...
public final class w extends i implements n {
    ...
    public w(long v, a a0, b0 b00, Continuation continuation0) {
        this.B = v;
        this.D = a0;
        this.E = b00;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        Continuation continuation1 = new w(this.B, this.D, this.E, continuation0);
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        while(true) {
            Vb.i i0 = new Vb.i(10);
            String s = TimeUtils.INSTANCE.getRemainedTimeTextOrDefault(this.B, System.currentTimeMillis(), i0);
            this.E.setValue(s);
        label_10:
