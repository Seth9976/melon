...
public final class q extends i implements n {
    ...
    public q(N n0, CommentConfig commentConfig0, CommentUiModel commentUiModel0, k k0, d d0, Y1 y10, Continuation continuation0) {
        this.w = n0;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new q(this.w, this.B, this.D, ((k)this.E), this.G, this.I, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        a a0 = a.a;
        CommentUiModel commentUiModel0 = this.D;
        CommentConfig commentConfig0 = this.B;
        switch(this.r) {
            case 0: {
                d5.n.D(object0);
                this.r = 1;
                object0 = this.w.c(commentConfig0.getChannelSeq(), commentUiModel0.getCommentSeq(), commentConfig0.getContentRefValue(), this);
                if(object0 == a0) {
                    return a0;
                }
                break;
        ...
        if(((Q)object0) instanceof P) {
            ...
            ((k)n0).invoke(new F1(commentUiModel0.getCommentSeq()));
            R3 r30 = new R3(commentConfig0.getChannelSeq(), commentConfig0.getContentRefValue(), false);
            this.I.invoke(r30);
            ((k)n0).invoke(new A1(r30));
            return H.a;
        }
