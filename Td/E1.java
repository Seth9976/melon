...
public final class e1 extends i implements n {
    ...
    public e1(Continuation continuation0, t1 t10) {
        this.w = t10;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new e1(continuation0, this.w);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        if(((Boolean)object0).booleanValue()) {
            t10.sendUiEvent(new ShowSelectionRepeatInterruptPopup(new L0(t10, 6)));
            return H.a;
        }
        this.r = 2;
        return t1.d(t10, this) == a0 ? a0 : H.a;
    }
}
