...
public final class DoubleArrayBuilder extends PrimitiveArrayBuilder {
    ...
    public final void append$kotlinx_serialization_core(double f) {
    ...
    public double[] build$kotlinx_serialization_core() {
        double[] arr_f = Arrays.copyOf(this.buffer, this.getPosition$kotlinx_serialization_core());
        q.f(arr_f, "copyOf(...)");
        return arr_f;
    }
