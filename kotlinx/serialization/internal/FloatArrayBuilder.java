...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0014\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0007\n\u0002\b\u000F\b\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0011\b\u0000\u0012\u0006\u0010\u0003\u001A\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0017\u0010\u000B\u001A\u00020\b2\u0006\u0010\u0007\u001A\u00020\u0006H\u0010¢\u0006\u0004\b\t\u0010\nJ\u0017\u0010\u0010\u001A\u00020\b2\u0006\u0010\r\u001A\u00020\fH\u0000¢\u0006\u0004\b\u000E\u0010\u000FJ\u000F\u0010\u0013\u001A\u00020\u0002H\u0010¢\u0006\u0004\b\u0011\u0010\u0012R\u0016\u0010\u0014\u001A\u00020\u00028\u0002@\u0002X\u0082\u000E¢\u0006\u0006\n\u0004\b\u0014\u0010\u0015R$\u0010\u0017\u001A\u00020\u00062\u0006\u0010\u0016\u001A\u00020\u00068\u0010@RX\u0090\u000E¢\u0006\f\n\u0004\b\u0017\u0010\u0018\u001A\u0004\b\u0019\u0010\u001A¨\u0006\u001B"}, d2 = {"Lkotlinx/serialization/internal/FloatArrayBuilder;", "Lkotlinx/serialization/internal/PrimitiveArrayBuilder;", "", "bufferWithData", "<init>", "([F)V", "", "requiredCapacity", "Lie/H;", "ensureCapacity$kotlinx_serialization_core", "(I)V", "ensureCapacity", "", "c", "append$kotlinx_serialization_core", "(F)V", "append", "build$kotlinx_serialization_core", "()[F", "build", "buffer", "[F", "value", "position", "I", "getPosition$kotlinx_serialization_core", "()I", "kotlinx-serialization-core"}, k = 1, mv = {2, 0, 0}, xi = 0x30)
public final class FloatArrayBuilder extends PrimitiveArrayBuilder {
    ...
    public FloatArrayBuilder(@NotNull float[] arr_f) {
        q.g(arr_f, "bufferWithData");
        super();
        this.buffer = arr_f;
        this.position = arr_f.length;
    ...
    public float[] build$kotlinx_serialization_core() {
        float[] arr_f = Arrays.copyOf(this.buffer, this.getPosition$kotlinx_serialization_core());
        q.f(arr_f, "copyOf(...)");
        return arr_f;
    }
    ...
    public void ensureCapacity$kotlinx_serialization_core(int v) {
        float[] arr_f = this.buffer;
        if(arr_f.length < v) {
            int v1 = arr_f.length * 2;
            if(v < v1) {
                v = v1;
            }
