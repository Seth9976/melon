/*
   ...
   the type library 'libmelonDrmMeta.so'
*/
...
struct Elf64_Sym
{
  unsigned __int32 st_name __offset(OFF64,0x2104);
...
struct Elf64_Verneed
{
  ...
  unsigned __int32 vn_file __offset(OFF64,0x2104);
...
struct Elf64_Vernaux
{
  ...
  unsigned __int32 vna_name __offset(OFF64,0x2104);
