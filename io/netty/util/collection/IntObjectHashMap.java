...
public class IntObjectHashMap implements IntObjectMap {
    final class EntrySet extends AbstractSet {
        ...
        public EntrySet(io.netty.util.collection.IntObjectHashMap.1 intObjectHashMap$10) {
        }

        @Override
        public Iterator iterator() {
            return new MapIterator(IntObjectHashMap.this, null);
        }
    ...
    final class KeySet extends AbstractSet {
        ...
        public KeySet(io.netty.util.collection.IntObjectHashMap.1 intObjectHashMap$10) {
        }
        ...
        public boolean contains(Object object0) {
            return IntObjectHashMap.this.containsKey(object0);
        }
        ...
        public Iterator iterator() {
            return new Iterator() {
                ...
                public Integer next() {
                    ...
                    return (Integer)((Map.Entry)object0).getKey();
                }
        ...
        public boolean remove(Object object0) {
            return IntObjectHashMap.this.remove(object0) != null;
        }

        @Override
        public boolean retainAll(Collection collection0) {
            boolean z = false;
            Iterator iterator0 = IntObjectHashMap.this.entries().iterator();
    ...
    final class MapEntry implements Map.Entry {
        ...
        public Integer getKey() {
            this.verifyExists();
            return (int)IntObjectHashMap.this.keys[this.entryIndex];
        }
        ...
        public Object setValue(Object object0) {
            this.verifyExists();
            Object object1 = IntObjectHashMap.toExternal(IntObjectHashMap.this.values[this.entryIndex]);
            IntObjectHashMap.this.values[this.entryIndex] = IntObjectHashMap.toInternal(object0);
            return object1;
        }
    ...
    final class MapIterator implements Iterator {
        ...
        private MapIterator() {
            this.iter = new PrimitiveIterator(intObjectHashMap0, null);
        }

        public MapIterator(io.netty.util.collection.IntObjectHashMap.1 intObjectHashMap$10) {
        }
        ...
        public Map.Entry next() {
            ...
            this.iter.next();
            return new MapEntry(IntObjectHashMap.this, this.iter.entryIndex);
        }
    ...
    final class PrimitiveIterator implements PrimitiveEntry, Iterator {
        ...
        public PrimitiveIterator(io.netty.util.collection.IntObjectHashMap.1 intObjectHashMap$10) {
        }
        ...
        public void remove() {
            ...
            if(IntObjectHashMap.this.removeAt(v)) {
        ...
        private void scanNext() {
            ...
            while(v != IntObjectHashMap.this.values.length && IntObjectHashMap.this.values[this.nextIndex] == null);
        }
    ...
    static {
        IntObjectHashMap.NULL_VALUE = new Object();
    }
    ...
    public IntObjectHashMap(int v) {
        this(v, 0.5f);
    }

    public IntObjectHashMap(int v, float f) {
        this.keySet = new KeySet(this, null);
        this.entrySet = new EntrySet(this, null);
        this.entries = new Iterable() {
            @Override
            public Iterator iterator() {
                return new PrimitiveIterator(IntObjectHashMap.this, null);
            }
        };
        if(f <= 0.0f || f > 1.0f) {
    ...
    public boolean containsValue(Object object0) {
        Object object1 = IntObjectHashMap.toInternal(object0);
    ...
    public boolean equals(Object object0) {
        ...
        if(this.size != ((IntObjectMap)object0).size()) {
            return false;
        }
        for(int v = 0; true; ++v) {
            Object[] arr_object = this.values;
            ...
            if(object1 != null) {
                Object object2 = ((IntObjectMap)object0).get(this.keys[v]);
                if(object1 == IntObjectHashMap.NULL_VALUE) {
                    if(object2 != null) {
                        return false;
                    }
                }
    ...
    public Object get(int v) {
        ...
        return v1 == -1 ? null : IntObjectHashMap.toExternal(this.values[v1]);
    }
    ...
    private static int hashCode(int v) [...] // Inlined contents
    ...
    public int hashCode() {
        ...
        for(int v1 = 0; v1 < arr_v.length; ++v1) {
            v ^= IntObjectHashMap.hashCode(arr_v[v1]);
        }
        return v;
    }

    private int hashIndex(int v) {
        return v & this.mask;
    }
    ...
    public String keyToString(int v) {
        return Integer.toString(v);
    }

    private int objectToKey(Object object0) {
    ...
    public Object put(int v, Object object0) {
        ...
        do {
            ...
            if(object1 == null) {
                this.keys[v2] = v;
                arr_object[v2] = IntObjectHashMap.toInternal(object0);
                this.growSize();
                return null;
            }
            if(this.keys[v2] == v) {
                arr_object[v2] = IntObjectHashMap.toInternal(object0);
                return IntObjectHashMap.toExternal(object1);
            }
            v2 = this.probeNext(v2);
        }
        while(v2 != v1);
    ...
    public Object put(Integer integer0, Object object0) {
        return this.put(this.objectToKey(integer0), object0);
    }
    ...
    public void putAll(Map map0) {
        if(map0 instanceof IntObjectHashMap) {
            for(int v = 0; true; ++v) {
                Object[] arr_object = ((IntObjectHashMap)map0).values;
                if(v >= arr_object.length) {
                    break;
                }
                Object object0 = arr_object[v];
                if(object0 != null) {
                    this.put(((IntObjectHashMap)map0).keys[v], object0);
                }
            }
        }
        else {
            for(Object object1: map0.entrySet()) {
                this.put(((Integer)((Map.Entry)object1).getKey()), ((Map.Entry)object1).getValue());
            }
        }
    }
    ...
    public Object remove(int v) {
        ...
        this.removeAt(v1);
        return IntObjectHashMap.toExternal(object0);
    }
    ...
    private static Object toExternal(Object object0) {
        return object0 == IntObjectHashMap.NULL_VALUE ? null : object0;
    }

    private static Object toInternal(Object object0) {
        return object0 == null ? IntObjectHashMap.NULL_VALUE : object0;
    }
    ...
    public String toString() {
        ...
        for(int v = 0; true; ++v) {
            ...
            if(object0 != null) {
                ...
                stringBuilder0.append('=');
                String s = object0 == this ? "(this Map)" : IntObjectHashMap.toExternal(object0);
        ...
        return new AbstractCollection() {
            ...
            public Iterator iterator() {
                return new Iterator() {
                    ...
                    {
                        this.iter = new PrimitiveIterator(IntObjectHashMap.this, null);
                    }
