...
public class SwappedByteBuf extends ByteBuf {
    ...
    public ByteBuf copy(int v, int v1) {
        return this.buf.copy(v, v1).order(this.order);
    }
    ...
    public boolean equals(Object object0) {
        return object0 instanceof ByteBuf ? ByteBufUtil.equals(this, ((ByteBuf)object0)) : false;
    }
    ...
    public int getInt(int v) {
        return ByteBufUtil.swapInt(this.buf.getInt(v));
    }
    ...
    public long getLong(int v) {
        return ByteBufUtil.swapLong(this.buf.getLong(v));
    }
    ...
    public int getMedium(int v) {
        return ByteBufUtil.swapMedium(this.buf.getMedium(v));
    }
    ...
    public short getShort(int v) {
        return ByteBufUtil.swapShort(this.buf.getShort(v));
    }
    ...
    public int getUnsignedMedium(int v) {
        return this.getMedium(v) & 0xFFFFFF;
    }

    @Override  // io.netty.buffer.ByteBuf
    public int getUnsignedMediumLE(int v) {
        return this.getMediumLE(v) & 0xFFFFFF;
    }
    ...
    public ByteBuffer nioBuffer(int v, int v1) {
        return this.buf.nioBuffer(v, v1).order(this.order);
    }
    ...
    public ByteBuffer[] nioBuffers() {
        ByteBuffer[] arr_byteBuffer = this.buf.nioBuffers();
        for(int v = 0; v < arr_byteBuffer.length; ++v) {
            arr_byteBuffer[v] = arr_byteBuffer[v].order(this.order);
        }
    ...
    public ByteBuffer[] nioBuffers(int v, int v1) {
        ByteBuffer[] arr_byteBuffer = this.buf.nioBuffers(v, v1);
        for(int v2 = 0; v2 < arr_byteBuffer.length; ++v2) {
            arr_byteBuffer[v2] = arr_byteBuffer[v2].order(this.order);
        }
        return arr_byteBuffer;
    }
    ...
    public ByteBuf order(ByteOrder byteOrder0) {
        return ObjectUtil.checkNotNull(byteOrder0, "endianness") == this.order ? this : this.buf;
    }
    ...
    public ByteBuf readBytes(int v) {
        return this.buf.readBytes(v).order(this.order());
    }
    ...
    public ByteBuf readRetainedSlice(int v) {
        return this.buf.readRetainedSlice(v).order(this.order);
    }
    ...
    public ByteBuf readSlice(int v) {
        return this.buf.readSlice(v).order(this.order);
    }
    ...
    public ByteBuf retainedSlice(int v, int v1) {
        return this.buf.retainedSlice(v, v1).order(this.order);
    }
    ...
    public ByteBuf setInt(int v, int v1) {
        this.buf.setInt(v, ByteBufUtil.swapInt(v1));
        return this;
    }
    ...
    public ByteBuf setLong(int v, long v1) {
        this.buf.setLong(v, ByteBufUtil.swapLong(v1));
        return this;
    }
    ...
    public ByteBuf setMedium(int v, int v1) {
        this.buf.setMedium(v, ByteBufUtil.swapMedium(v1));
        return this;
    }
    ...
    public ByteBuf setShort(int v, int v1) {
        this.buf.setShort(v, ByteBufUtil.swapShort(((short)v1)));
        return this;
    }

    @Override  // io.netty.buffer.ByteBuf
    public ByteBuf setShortLE(int v, int v1) {
        this.buf.setShortLE(v, ((int)(((short)v1))));
        return this;
    }
    ...
    public ByteBuf slice(int v, int v1) {
        return this.buf.slice(v, v1).order(this.order);
    }
    ...
    public ByteBuf writeInt(int v) {
        this.buf.writeInt(ByteBufUtil.swapInt(v));
        return this;
    }
    ...
    public ByteBuf writeLong(long v) {
        this.buf.writeLong(ByteBufUtil.swapLong(v));
        return this;
    }
    ...
    public ByteBuf writeMedium(int v) {
        this.buf.writeMedium(ByteBufUtil.swapMedium(v));
        return this;
    }
    ...
    public ByteBuf writeShort(int v) {
        this.buf.writeShort(ByteBufUtil.swapShort(((short)v)));
        return this;
    }

    @Override  // io.netty.buffer.ByteBuf
    public ByteBuf writeShortLE(int v) {
        this.buf.writeShortLE(((int)(((short)v))));
        return this;
    }
