...
public final class r extends i implements n {
    ...
    public r(Context context0, String s, z z0, Continuation continuation0) {
        this.B = context0;
        this.D = s;
        this.E = z0;
    ...
    public final Object invoke(Object object0, Object object1) {
        return ((r)this.create(((ProducerScope)object0), ((Continuation)object1))).invokeSuspend(H.a);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.r) {
            case 0: {
                d5.n.D(object0);
                RequestBuilder requestBuilder0 = Glide.with(this.B).load(this.D).listener(new q(producerScope0));
                kotlin.jvm.internal.q.f(requestBuilder0, "listener(...)");
                if(this.E.a == 3) {
