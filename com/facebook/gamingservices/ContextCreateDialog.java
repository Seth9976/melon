...
@Metadata(d1 = {"\u0000h\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000B\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\b\u0018\u0000 *2\u000E\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001:\u0004*+,-B\u0011\b\u0016\u0012\u0006\u0010\u0005\u001A\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007B\u0011\b\u0016\u0012\u0006\u0010\t\u001A\u00020\b¢\u0006\u0004\b\u0006\u0010\nB\u0011\b\u0016\u0012\u0006\u0010\t\u001A\u00020\u000B¢\u0006\u0004\b\u0006\u0010\fB\u0011\b\u0012\u0012\u0006\u0010\u000E\u001A\u00020\r¢\u0006\u0004\b\u0006\u0010\u000FJ\u0017\u0010\u0012\u001A\u00020\u00112\u0006\u0010\u0010\u001A\u00020\u0002H\u0002¢\u0006\u0004\b\u0012\u0010\u0013J\u0017\u0010\u0015\u001A\u00020\u00142\u0006\u0010\u0010\u001A\u00020\u0002H\u0016¢\u0006\u0004\b\u0015\u0010\u0016J\u001F\u0010\u0019\u001A\u00020\u00112\u0006\u0010\u0010\u001A\u00020\u00022\u0006\u0010\u0018\u001A\u00020\u0017H\u0014¢\u0006\u0004\b\u0019\u0010\u001AJ%\u0010\u001F\u001A\u00020\u00112\u0006\u0010\u001C\u001A\u00020\u001B2\f\u0010\u001E\u001A\b\u0012\u0004\u0012\u00020\u00030\u001DH\u0014¢\u0006\u0004\b\u001F\u0010 J\u000F\u0010\"\u001A\u00020!H\u0014¢\u0006\u0004\b\"\u0010#R\u001E\u0010\u001E\u001A\n\u0012\u0004\u0012\u00020\u0003\u0018\u00010\u001D8\u0002@\u0002X\u0082\u000E¢\u0006\u0006\n\u0004\b\u001E\u0010$R*\u0010)\u001A\u0018\u0012\u0014\u0012\u00120&R\u000E\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u00010%8TX\u0094\u0004¢\u0006\u0006\u001A\u0004\b\'\u0010(¨\u0006."}, d2 = {"Lcom/facebook/gamingservices/ContextCreateDialog;", "Lcom/facebook/internal/FacebookDialogBase;", "Lcom/facebook/gamingservices/model/ContextCreateContent;", "Lcom/facebook/gamingservices/ContextCreateDialog$Result;", "Landroid/app/Activity;", "activity", "<init>", "(Landroid/app/Activity;)V", "Landroidx/fragment/app/I;", "fragment", "(Landroidx/fragment/app/I;)V", "Landroid/app/Fragment;", "(Landroid/app/Fragment;)V", "Lcom/facebook/internal/FragmentWrapper;", "fragmentWrapper", "(Lcom/facebook/internal/FragmentWrapper;)V", "content", "Lie/H;", "showForCloud", "(Lcom/facebook/gamingservices/model/ContextCreateContent;)V", "", "canShow", "(Lcom/facebook/gamingservices/model/ContextCreateContent;)Z", "", "mode", "showImpl", "(Lcom/facebook/gamingservices/model/ContextCreateContent;Ljava/lang/Object;)V", "Lcom/facebook/internal/CallbackManagerImpl;", "callbackManager", "Lcom/facebook/FacebookCallback;", "callback", "registerCallbackImpl", "(Lcom/facebook/internal/CallbackManagerImpl;Lcom/facebook/FacebookCallback;)V", "Lcom/facebook/internal/AppCall;", "createBaseAppCall", "()Lcom/facebook/internal/AppCall;", "Lcom/facebook/FacebookCallback;", "", "Lcom/facebook/internal/FacebookDialogBase$ModeHandler;", "getOrderedModeHandlers", "()Ljava/util/List;", "orderedModeHandlers", "Companion", "FacebookAppHandler", "Result", "WebHandler", "facebook-gamingservices_release"}, k = 1, mv = {1, 8, 0}, xi = 0x30)
public final class ContextCreateDialog extends FacebookDialogBase {
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000E\u0010\u0003\u001A\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lcom/facebook/gamingservices/ContextCreateDialog$Companion;", "", "()V", "DEFAULT_REQUEST_CODE", "", "facebook-gamingservices_release"}, k = 1, mv = {1, 8, 0}, xi = 0x30)
    ...
    final class FacebookAppHandler extends ModeHandler {
        public boolean canShow(@NotNull ContextCreateContent contextCreateContent0, boolean z) {
            q.g(contextCreateContent0, "content");
            Activity activity0 = ContextCreateDialog.this.getActivityContext();
            String s = null;
        ...
        public boolean canShow(Object object0, boolean z) {
            return this.canShow(((ContextCreateContent)object0), z);
        }

        @NotNull
        public AppCall createAppCall(@NotNull ContextCreateContent contextCreateContent0) {
            q.g(contextCreateContent0, "content");
            AppCall appCall0 = ContextCreateDialog.this.createBaseAppCall();
            Intent intent0 = new Intent("com.facebook.games.gaming_services.DEEPLINK");
            intent0.setType("text/plain");
            AccessToken accessToken0 = AccessToken.Companion.getCurrentAccessToken();
            Bundle bundle0 = Y.b("deeplink", "CONTEXT_CREATE");
            if(accessToken0 == null) {
            ...
            if(contextCreateContent0.getSuggestedPlayerID() != null) {
                bundle0.putString("player_id", contextCreateContent0.getSuggestedPlayerID());
            }
        ...
        public AppCall createAppCall(Object object0) {
            return this.createAppCall(((ContextCreateContent)object0));
        }
    }

    @Metadata(d1 = {"\u0000\u001A\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000E\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\u000F\b\u0010\u0012\u0006\u0010\u0002\u001A\u00020\u0003¢\u0006\u0002\u0010\u0004B\u000F\b\u0010\u0012\u0006\u0010\u0005\u001A\u00020\u0006¢\u0006\u0002\u0010\u0007R\u001C\u0010\u0002\u001A\u0004\u0018\u00010\u0003X\u0086\u000E¢\u0006\u000E\n\u0000\u001A\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u0004¨\u0006\u000B"}, d2 = {"Lcom/facebook/gamingservices/ContextCreateDialog$Result;", "", "contextID", "", "(Ljava/lang/String;)V", "response", "Lcom/facebook/GraphResponse;", "(Lcom/facebook/GraphResponse;)V", "getContextID", "()Ljava/lang/String;", "setContextID", "facebook-gamingservices_release"}, k = 1, mv = {1, 8, 0}, xi = 0x30)
    ...
    static {
        ContextCreateDialog.Companion = new Companion(null);
        ContextCreateDialog.DEFAULT_REQUEST_CODE = RequestCodeOffset.GamingContextCreate.toRequestCode();
    }

    public ContextCreateDialog(@NotNull Activity activity0) {
        q.g(activity0, "activity");
        super(activity0, ContextCreateDialog.DEFAULT_REQUEST_CODE);
    }

    public ContextCreateDialog(@NotNull Fragment fragment0) {
        q.g(fragment0, "fragment");
        this(new FragmentWrapper(fragment0));
    }

    public ContextCreateDialog(@NotNull I i0) {
        q.g(i0, "fragment");
        this(new FragmentWrapper(i0));
    }

    private ContextCreateDialog(FragmentWrapper fragmentWrapper0) {
        super(fragmentWrapper0, ContextCreateDialog.DEFAULT_REQUEST_CODE);
    }

    public static void a(ContextCreateDialog contextCreateDialog0, GraphResponse graphResponse0) {
        ContextCreateDialog.showForCloud$lambda$2(contextCreateDialog0, graphResponse0);
    }

    // 去混淆评级： 低(25)
    public boolean canShow(@NotNull ContextCreateContent contextCreateContent0) {
        q.g(contextCreateContent0, "content");
        return new FacebookAppHandler(this).canShow(contextCreateContent0, true) || new WebHandler(this).canShow(contextCreateContent0, true);
    }

    @Override  // com.facebook.internal.FacebookDialogBase
    public boolean canShow(Object object0) {
        return this.canShow(((ContextCreateContent)object0));
    }
            ...
            public void onSuccess(@NotNull AppCall appCall0, @Nullable Bundle bundle0) {
                ...
                if(bundle0 != null) {
                    ...
                    if(s != null) {
                        ...
                        Result contextCreateDialog$Result0 = new Result(s);
                        this.$callback.onSuccess(contextCreateDialog$Result0);
                    }
                    else if(s1 != null) {
                        GamingContext gamingContext1 = new GamingContext(s1);
                        GamingContext.Companion.setCurrentGamingContext(gamingContext1);
                        Result contextCreateDialog$Result1 = new Result(s1);
                        this.$callback.onSuccess(contextCreateDialog$Result1);
                    }
    ...
    private static final boolean registerCallbackImpl$lambda$3(ContextCreateDialog contextCreateDialog0, ResultProcessor resultProcessor0, int v, Intent intent0) {
        q.g(contextCreateDialog0, "this$0");
        q.g(resultProcessor0, "$resultProcessor");
        return ShareInternalUtility.handleActivityResult(contextCreateDialog0.getRequestCode(), v, intent0, resultProcessor0);
    }

    private final void showForCloud(ContextCreateContent contextCreateContent0) {
        AccessToken accessToken0 = AccessToken.Companion.getCurrentAccessToken();
        ...
        a0 a00 = new a0(this, 14);
        JSONObject jSONObject0 = new JSONObject();
        try {
            if(contextCreateContent0.getSuggestedPlayerID() != null) {
                jSONObject0.put("id", contextCreateContent0.getSuggestedPlayerID());
            }
            DaemonRequest.executeAsync(this.getActivityContext(), jSONObject0, a00, SDKMessageEnum.CONTEXT_CREATE);
        }
        catch(JSONException unused_ex) {
            FacebookCallback facebookCallback0 = this.callback;
            if(facebookCallback0 != null) {
                facebookCallback0.onError(new FacebookException("Couldn\'t prepare Context Create Dialog"));
            }
        }
    }

    private static final void showForCloud$lambda$2(ContextCreateDialog contextCreateDialog0, GraphResponse graphResponse0) {
        H h0;
        q.g(contextCreateDialog0, "this$0");
        FacebookCallback facebookCallback0 = contextCreateDialog0.callback;
        if(facebookCallback0 != null) {
    ...
    public void showImpl(@NotNull ContextCreateContent contextCreateContent0, @NotNull Object object0) {
        q.g(contextCreateContent0, "content");
        q.g(object0, "mode");
        super.showImpl(contextCreateContent0, object0);
    }

    @Override  // com.facebook.internal.FacebookDialogBase
    public void showImpl(Object object0, Object object1) {
        this.showImpl(((ContextCreateContent)object0), object1);
    }
}
