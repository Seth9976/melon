...
public enum ConversionsAPICustomEventField {
    ...
    private static final ConversionsAPICustomEventField[] $values() [...] // Inlined contents

    private ConversionsAPICustomEventField(String s1) {
        this.rawValue = s1;
    }
