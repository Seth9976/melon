...
public enum ConversionsAPIUserAndAppDataField {
    ...
    private static final ConversionsAPIUserAndAppDataField[] $values() [...] // Inlined contents

    private ConversionsAPIUserAndAppDataField(String s1) {
        this.rawValue = s1;
    }
