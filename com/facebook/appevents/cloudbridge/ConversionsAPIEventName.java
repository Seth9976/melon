...
public enum ConversionsAPIEventName {
    ...
    private static final ConversionsAPIEventName[] $values() [...] // Inlined contents

    private ConversionsAPIEventName(String s1) {
        this.rawValue = s1;
    }
