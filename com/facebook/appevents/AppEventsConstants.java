...
public final class AppEventsConstants {
    ...
    @NotNull
    public static final AppEventsConstants INSTANCE;

    static {
        AppEventsConstants.INSTANCE = new AppEventsConstants();
    }

    @d
    public static void getEVENT_NAME_PURCHASED$annotations() {
    }
}
