...
public final class InstagramAppLoginMethodHandler.Companion.CREATOR.1 implements Parcelable.Creator {
    @NotNull
    public InstagramAppLoginMethodHandler createFromParcel(@NotNull Parcel parcel0) {
        q.g(parcel0, "source");
        return new InstagramAppLoginMethodHandler(parcel0);
    }
    ...
    @NotNull
    public InstagramAppLoginMethodHandler[] newArray(int v) {
        return new InstagramAppLoginMethodHandler[v];
    }
