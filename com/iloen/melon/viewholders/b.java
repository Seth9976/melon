...
public final class b implements View.OnClickListener {
    ...
    public b(DjPlaylistNewHolderImpl djPlaylistNewHolderImpl0, DjPlayListInfoBase djPlayListInfoBase0) {
    ...
    public final void onClick(View view0) {
        ...
        if(djPlaylistNewHolderImpl0.mOnClickListener != null) {
            djPlaylistNewHolderImpl0.mOnClickListener.clickBody(this.a);
        }
    }
}
