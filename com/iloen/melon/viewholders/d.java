...
public final class d implements View.OnClickListener {
    ...
    public d(DjPlaylistNewHolderImpl djPlaylistNewHolderImpl0, DjPlayListInfoBase djPlayListInfoBase0) {
    ...
    public final void onClick(View view0) {
        ...
        if(djPlaylistNewHolderImpl0.mOnClickListener != null) {
            djPlaylistNewHolderImpl0.mOnClickListener.clickThumbnail(this.a);
        }
    }
}
