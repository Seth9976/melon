...
public final class m implements View.OnClickListener {
    ...
    public m(PlaylistNewHolderImpl playlistNewHolderImpl0, ArtistPlayListInfoBase artistPlayListInfoBase0) {
    ...
    public final void onClick(View view0) {
        ...
        if(playlistNewHolderImpl0.mOnClickListener != null) {
            playlistNewHolderImpl0.mOnClickListener.clickMore(this.a);
        }
    }
}
