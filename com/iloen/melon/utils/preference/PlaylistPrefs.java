...
public class PlaylistPrefs extends SharedPrefsHelper {
    public PlaylistPrefs(Context context0, int v) {
        super(context0, "DbPlaylist_" + v);
    }
    ...
    public boolean setBulk(ContentValues contentValues0) {
        for(Object object0: contentValues0.keySet()) {
            contentValues0.getAsString(((String)object0));
        }
        return true;
    }
