...
public abstract class Hilt_CashFriendsFragment extends MetaContentBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_CashFriendsFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((CashFriendsFragment_GeneratedInjector)this.generatedComponent()).injectCashFriendsFragment(((CashFriendsFragment)this));
        }
    }
