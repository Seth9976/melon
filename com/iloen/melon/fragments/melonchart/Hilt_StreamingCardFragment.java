...
public abstract class Hilt_StreamingCardFragment extends MetaContentBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_StreamingCardFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((StreamingCardFragment_GeneratedInjector)this.generatedComponent()).injectStreamingCardFragment(((StreamingCardFragment)this));
        }
    }
