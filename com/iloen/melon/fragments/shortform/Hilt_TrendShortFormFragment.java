...
public abstract class Hilt_TrendShortFormFragment extends FetcherBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_TrendShortFormFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((TrendShortFormFragment_GeneratedInjector)this.generatedComponent()).injectTrendShortFormFragment(((TrendShortFormFragment)this));
        }
    }
