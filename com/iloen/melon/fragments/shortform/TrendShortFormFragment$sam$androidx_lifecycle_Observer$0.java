...
final class TrendShortFormFragment.sam.androidx_lifecycle_Observer.0 implements M, k {
    private final we.k function;

    public TrendShortFormFragment.sam.androidx_lifecycle_Observer.0(we.k k0) {
        q.g(k0, "function");
        super();
        this.function = k0;
    }
