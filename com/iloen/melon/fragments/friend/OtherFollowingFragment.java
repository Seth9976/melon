...
import com.iloen.melon.net.v6x.request.ListFollowingRecentAddReq.Params;
...
public final class OtherFollowingFragment extends MetaContentBaseFragment {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final OtherFollowingFragment newInstance(@Nullable String s) {
            OtherFollowingFragment otherFollowingFragment0 = new OtherFollowingFragment();
            Bundle bundle0 = new Bundle();
            bundle0.putString("argOtherMemberKey", s);
            otherFollowingFragment0.setArguments(bundle0);
            return otherFollowingFragment0;
        }
    }

    @Metadata(d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\b\u0003\n\u0002\u0010\u000E\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000B\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0082\u0004\u0018\u00002\u0010\u0012\u0006\u0012\u0004\u0018\u00010\u0002\u0012\u0004\u0012\u00020\u00030\u0001B#\u0012\b\u0010\u0005\u001A\u0004\u0018\u00010\u0004\u0012\u0010\u0010\u0007\u001A\f\u0012\u0006\u0012\u0004\u0018\u00010\u0002\u0018\u00010\u0006¢\u0006\u0004\b\b\u0010\tJ\'\u0010\u0011\u001A\u00020\u00102\u0006\u0010\u000B\u001A\u00020\n2\u0006\u0010\r\u001A\u00020\f2\u0006\u0010\u000F\u001A\u00020\u000EH\u0014¢\u0006\u0004\b\u0011\u0010\u0012J\u000F\u0010\u0014\u001A\u00020\u0013H\u0014¢\u0006\u0004\b\u0014\u0010\u0015J\u001F\u0010\u0018\u001A\u00020\u00132\u0006\u0010\u0016\u001A\u00020\u00132\u0006\u0010\u0017\u001A\u00020\u0013H\u0016¢\u0006\u0004\b\u0018\u0010\u0019J\u001F\u0010\u001D\u001A\u00020\u00032\u0006\u0010\u001B\u001A\u00020\u001A2\u0006\u0010\u001C\u001A\u00020\u0013H\u0016¢\u0006\u0004\b\u001D\u0010\u001EJ\'\u0010!\u001A\u00020 2\u0006\u0010\u001F\u001A\u00020\u00032\u0006\u0010\u0016\u001A\u00020\u00132\u0006\u0010\u0017\u001A\u00020\u0013H\u0016¢\u0006\u0004\b!\u0010\"R\u0014\u0010#\u001A\u00020\u00138\u0002X\u0082D¢\u0006\u0006\n\u0004\b#\u0010$R\u0014\u0010%\u001A\u00020\u00138\u0002X\u0082D¢\u0006\u0006\n\u0004\b%\u0010$¨\u0006&"}, d2 = {"Lcom/iloen/melon/fragments/friend/OtherFollowingFragment$FollowingAdapter;", "Lcom/iloen/melon/adapters/common/p;", "Lcom/iloen/melon/net/v6x/response/ListFollowingFollowerRes$RESPONSE$USERLIST;", "Landroidx/recyclerview/widget/O0;", "Landroid/content/Context;", "context", "", "list", "<init>", "(Lcom/iloen/melon/fragments/friend/OtherFollowingFragment;Landroid/content/Context;Ljava/util/List;)V", "", "key", "Lv9/i;", "type", "Lcom/iloen/melon/net/HttpResponse;", "response", "", "handleResponse", "(Ljava/lang/String;Lv9/i;Lcom/iloen/melon/net/HttpResponse;)Z", "", "getHeaderViewItemCount", "()I", "rawPosition", "position", "getItemViewTypeImpl", "(II)I", "Landroid/view/ViewGroup;", "parent", "viewType", "onCreateViewHolderImpl", "(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/O0;", "viewHolder", "Lie/H;", "onBindViewImpl", "(Landroidx/recyclerview/widget/O0;II)V", "VIEW_TYPE_TOP_FILTER", "I", "VIEW_TYPE_FRIEND", "app_playstoreProdRelease"}, k = 1, mv = {2, 2, 0}, xi = 0x30)
    final class FollowingAdapter extends p {
        private final int VIEW_TYPE_FRIEND;
        private final int VIEW_TYPE_TOP_FILTER;

        public FollowingAdapter(@Nullable Context context0, @Nullable List list0) {
        ...
        public void onBindViewImpl(@NotNull O0 o00, int v, int v1) {
            ...
            if(o00 instanceof m) {
                ...
                if(listFollowingFollowerRes$RESPONSE$USERLIST0 != null) {
                    com.iloen.melon.fragments.friend.i i0 = new com.iloen.melon.fragments.friend.i(listFollowingFollowerRes$RESPONSE$USERLIST0, 3);
                    ViewUtils.setOnClickListener(o00.itemView, i0);
                    TextView textView0 = ((m)o00).f;
                    TextView textView1 = ((m)o00).d;
                    FollowToggleButton followToggleButton0 = ((m)o00).h;
                    String s = listFollowingFollowerRes$RESPONSE$USERLIST0.mypageimg;
                    Glide.with(((m)o00).b.getContext()).load(s).apply(RequestOptions.circleCropTransform()).into(((m)o00).b);
                    ((m)o00).e.setText(listFollowingFollowerRes$RESPONSE$USERLIST0.membernickname);
                    int v3 = ResourceUtils.getDjIconColorId(listFollowingFollowerRes$RESPONSE$USERLIST0.memberDjIconType);
                    if(v3 > -1) {
                        ViewUtils.showWhen(textView1, true);
                        textView1.setTextColor(ColorUtils.getColor(this.getContext(), v3));
                    }
                    else {
                        ViewUtils.hideWhen(textView1, true);
                    }
                    ViewUtils.showWhen(((m)o00).g, listFollowingFollowerRes$RESPONSE$USERLIST0.isOfficial);
                    String s1 = listFollowingFollowerRes$RESPONSE$USERLIST0.myPageDesc;
                    ...
                    if(q.b(listFollowingFollowerRes$RESPONSE$USERLIST0.memberkey, u.v(((e0)o.a()).j()))) {
                        ...
                        ViewUtils.setOnClickListener(followToggleButton0, new j(listFollowingFollowerRes$RESPONSE$USERLIST0, OtherFollowingFragment.this, o00, 3));
                    }
                ...
                OtherFollowingFragment otherFollowingFragment0 = OtherFollowingFragment.this;
                if(otherFollowingFragment0.followingCount.length() <= 0) {
                    v2 = 4;
                }
                melonTextView1.setVisibility(v2);
                q.f("전체 %s명", "getString(...)");
                l1.D(new Object[]{otherFollowingFragment0.followingCount}, 1, "전체 %s명", melonTextView1);
                List list0 = OtherFollowingFragment.this.getFilterTexts();
                melonTextView0.setText(((String)je.p.n0(OtherFollowingFragment.this.filterIndex, list0)));
                melonTextView0.setOnClickListener(new g(OtherFollowingFragment.this, o00, 3));
            }
        }
        ...
        private static final void onBindViewImpl$lambda$5(USERLIST listFollowingFollowerRes$RESPONSE$USERLIST0, OtherFollowingFragment otherFollowingFragment0, O0 o00, View view0) {
            if(listFollowingFollowerRes$RESPONSE$USERLIST0.ismyfriend) {
                otherFollowingFragment0.unfollow(listFollowingFollowerRes$RESPONSE$USERLIST0, new f(listFollowingFollowerRes$RESPONSE$USERLIST0, o00, 6));
                return;
            }
            otherFollowingFragment0.follow(listFollowingFollowerRes$RESPONSE$USERLIST0, new f(listFollowingFollowerRes$RESPONSE$USERLIST0, o00, 7));
        }

        private static final H onBindViewImpl$lambda$5$lambda$3(USERLIST listFollowingFollowerRes$RESPONSE$USERLIST0, O0 o00) {
            listFollowingFollowerRes$RESPONSE$USERLIST0.ismyfriend = false;
            ((m)o00).h.setType(0);
            return H.a;
        }

        private static final H onBindViewImpl$lambda$5$lambda$4(USERLIST listFollowingFollowerRes$RESPONSE$USERLIST0, O0 o00) {
            listFollowingFollowerRes$RESPONSE$USERLIST0.ismyfriend = true;
            ((m)o00).h.setType(1);
            return H.a;
        }

        private static final void onBindViewImpl$lambda$8(OtherFollowingFragment otherFollowingFragment0, O0 o00, View view0) {
            if(otherFollowingFragment0.isPossiblePopupShow()) {
                FragmentActivity fragmentActivity0 = otherFollowingFragment0.getActivity();
                if(fragmentActivity0 != null) {
                    ...
                    bottomSingleFilterListPopup0.setFilterItem(otherFollowingFragment0.getFilterTexts(), otherFollowingFragment0.filterIndex);
                    bottomSingleFilterListPopup0.setFilterListener(new com.iloen.melon.fragments.friend.e(otherFollowingFragment0, o00, 3));
                    bottomSingleFilterListPopup0.setOnDismissListener(otherFollowingFragment0.mDialogDismissListener);
                    otherFollowingFragment0.mRetainDialog = bottomSingleFilterListPopup0;
                    bottomSingleFilterListPopup0.show();
                }
            }
        }

        private static final void onBindViewImpl$lambda$8$lambda$7(OtherFollowingFragment otherFollowingFragment0, O0 o00, int v) {
            otherFollowingFragment0.filterIndex = v;
            String s = (String)je.p.n0(otherFollowingFragment0.filterIndex, otherFollowingFragment0.getFilterTexts());
            ((e)o00).b.setText(s);
            otherFollowingFragment0.startFetch("filter change");
        }
    ...
    static {
        OtherFollowingFragment.Companion = new Companion(null);
        OtherFollowingFragment.$stable = 8;
    }

    public OtherFollowingFragment() {
        this.otherMemberKey = "";
        this.followingCount = "";
        this.filterTexts$delegate = d3.g.Q(new d(this, 3));
    }
    ...
    private static final List filterTexts_delegate$lambda$0(OtherFollowingFragment otherFollowingFragment0) {
        String[] arr_s;
        Context context0 = otherFollowingFragment0.getContext();
        if(context0 == null) {
            arr_s = null;
        }
        else {
            Resources resources0 = context0.getResources();
            arr_s = resources0 == null ? null : resources0.getStringArray(0x7F030045);  // array:sortingbar_other_following
        }
    ...
    public String getCacheKey() {
        return l1.e(MelonContentUris.G0.buildUpon(), this.otherMemberKey, "toString(...)");
    }
    ...
    private final HttpRequest getRequest(i i0) {
        ...
        q.e(j00, "null cannot be cast to non-null type com.iloen.melon.fragments.friend.OtherFollowingFragment.FollowingAdapter");
        i i1 = i.b;
        int v = 1;
        switch(this.filterIndex) {
            case 0: {
                Params listFollowingRecentAddReq$Params0 = new Params();
                if(!i1.equals(i0)) {
                    v = ((FollowingAdapter)j00).getCount() + 1;
                }
                listFollowingRecentAddReq$Params0.startIndex = v;
                listFollowingRecentAddReq$Params0.pageSize = 100;
                listFollowingRecentAddReq$Params0.targetMemberKey = this.otherMemberKey;
            ...
            case 1: {
                ...
                listFollowingDjReq$Params0.startIndex = v;
                listFollowingDjReq$Params0.pageSize = 100;
                listFollowingDjReq$Params0.targetMemberKey = this.otherMemberKey;
    ...
    public boolean onFetchStart(@NotNull i i0, @NotNull h h0, @NotNull String s) {
        ...
        RequestBuilder.newInstance(this.getRequest(i0)).tag(this.getRequestTag()).listener(new com.iloen.melon.fragments.friend.e(this, i0, 7)).errorListener(new l(this, 3)).request();
        return true;
    }

    private static final void onFetchStart$lambda$1(OtherFollowingFragment otherFollowingFragment0, i i0, ListFollowingFollowerRes listFollowingFollowerRes0) {
        String s;
        if(!otherFollowingFragment0.prepareFetchComplete(listFollowingFollowerRes0)) {
            otherFollowingFragment0.followingCount = "0";
            otherFollowingFragment0.mAdapter.notifyDataSetChanged();
            return;
        }
        ...
        otherFollowingFragment0.followingCount = s;
        otherFollowingFragment0.performFetchComplete(i0, listFollowingFollowerRes0);
    }

    private static final void onFetchStart$lambda$2(OtherFollowingFragment otherFollowingFragment0, VolleyError volleyError0) {
        otherFollowingFragment0.performFetchError(volleyError0);
        otherFollowingFragment0.followingCount = "";
        otherFollowingFragment0.mAdapter.notifyDataSetChanged();
    }

    @Override  // com.iloen.melon.fragments.MelonAdapterViewBaseFragment
    public void onRestoreInstanceState(@NotNull Bundle bundle0) {
        this.otherMemberKey = l1.g(bundle0, "inState", "argOtherMemberKey", "", "getString(...)");
    }
