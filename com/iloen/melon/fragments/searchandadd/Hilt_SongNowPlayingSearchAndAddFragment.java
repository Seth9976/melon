...
abstract class Hilt_SongNowPlayingSearchAndAddFragment extends SearchAndAddBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_SongNowPlayingSearchAndAddFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((SongNowPlayingSearchAndAddFragment_GeneratedInjector)this.generatedComponent()).injectSongNowPlayingSearchAndAddFragment(((SongNowPlayingSearchAndAddFragment)this));
        }
    }
