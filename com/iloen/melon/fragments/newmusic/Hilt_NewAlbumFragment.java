...
public abstract class Hilt_NewAlbumFragment extends MetaContentBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_NewAlbumFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((NewAlbumFragment_GeneratedInjector)this.generatedComponent()).injectNewAlbumFragment(((NewAlbumFragment)this));
        }
    }
