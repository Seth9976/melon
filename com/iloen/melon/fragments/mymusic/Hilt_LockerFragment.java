...
public abstract class Hilt_LockerFragment extends MetaContentBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_LockerFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((LockerFragment_GeneratedInjector)this.generatedComponent()).injectLockerFragment(((LockerFragment)this));
        }
    }
