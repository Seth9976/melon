...
public abstract class Hilt_ArtistPlaylistDetailFragment extends PlaylistDetailBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_ArtistPlaylistDetailFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((ArtistPlaylistDetailFragment_GeneratedInjector)this.generatedComponent()).injectArtistPlaylistDetailFragment(((ArtistPlaylistDetailFragment)this));
        }
    }
