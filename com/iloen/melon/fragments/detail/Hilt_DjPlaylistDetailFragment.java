...
public abstract class Hilt_DjPlaylistDetailFragment extends PlaylistDetailBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_DjPlaylistDetailFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((DjPlaylistDetailFragment_GeneratedInjector)this.generatedComponent()).injectDjPlaylistDetailFragment(((DjPlaylistDetailFragment)this));
        }
    }
