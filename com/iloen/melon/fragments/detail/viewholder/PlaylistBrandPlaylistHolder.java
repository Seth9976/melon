...
public final class PlaylistBrandPlaylistHolder extends PlaylistHolder {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final PlaylistBrandPlaylistHolder newInstance(@NotNull ViewGroup viewGroup0, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
            q.g(viewGroup0, "parent");
            q.g(onViewHolderActionBaseListener0, "onViewHolderActionListener");
            return new PlaylistBrandPlaylistHolder(e0.a(LayoutInflater.from(viewGroup0.getContext()), viewGroup0), onViewHolderActionBaseListener0);
        }
    }
    ...
    @NotNull
    public static final String TAG = "PlaylistBrandPlaylistHolder";

    static {
        PlaylistBrandPlaylistHolder.Companion = new Companion(null);
        PlaylistBrandPlaylistHolder.$stable = 8;
    }

    public PlaylistBrandPlaylistHolder(@NotNull e0 e00, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
        q.g(e00, "bind");
        q.g(onViewHolderActionBaseListener0, "onViewHolderActionListener");
    ...
    public String getTitleName() {
        return this.getString(0x7F130346);  // string:dj_playlist_title_brand_playlist "이 DJ의 플레이리스트"
    }
    ...
    public void itemClickLog(@NotNull ActionKind actionKind0, @NotNull String s, int v, @Nullable PLAYLIST detailBaseRes$PLAYLIST0) {
        ...
        if(f0 != null) {
            f0.d = actionKind0;
            f0.a = s;
            f0.y = this.getString(0x7F130E64);  // string:tiara_djplaylist_layer1_owners_playlist "제작자의 플레이리스트"
            f0.c(v + 1);
            String s1 = null;
    ...
    @NotNull
    public static final PlaylistBrandPlaylistHolder newInstance(@NotNull ViewGroup viewGroup0, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
        return PlaylistBrandPlaylistHolder.Companion.newInstance(viewGroup0, onViewHolderActionBaseListener0);
    }
        ...
        if(mainTabTitleView1 != null) {
            mainTabTitleView1.setOnEventListener(new SimpleEventListener() {
                ...
                public void onViewAllButtonClick(View view0) {
                    ...
                    f f0 = PlaylistBrandPlaylistHolder.this.getOnViewHolderActionListener().onTiaraEventBuilder();
                    if(f0 != null) {
                        f0.d = ActionKind.ClickContent;
                        f0.a = PlaylistBrandPlaylistHolder.this.getString(0x7F130DC9);  // string:tiara_common_action_name_move_page "페이지이동"
                        f0.y = PlaylistBrandPlaylistHolder.this.getString(0x7F130E64);  // string:tiara_djplaylist_layer1_owners_playlist "제작자의 플레이리스트"
                        f0.F = PlaylistBrandPlaylistHolder.this.getString(0x7F130DB1);  // string:tiara_click_copy_view_all "전체보기"
                        f0.a().track();
                    }
                }
            });
