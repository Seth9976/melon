...
public final class AlbumVideoHolder extends VideoHolder {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final AlbumVideoHolder newInstance(@NotNull ViewGroup viewGroup0, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
            q.g(viewGroup0, "parent");
            q.g(onViewHolderActionBaseListener0, "onViewHolderActionListener");
            return new AlbumVideoHolder(k0.a(LayoutInflater.from(viewGroup0.getContext()), viewGroup0), onViewHolderActionBaseListener0);
        }
    }
    ...
    static {
        AlbumVideoHolder.Companion = new Companion(null);
        AlbumVideoHolder.$stable = 8;
    }

    public AlbumVideoHolder(@NotNull k0 k00, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
        q.g(k00, "bind");
        q.g(onViewHolderActionBaseListener0, "onViewHolderActionListener");
    ...
    public String getTitleName() {
        return this.getString(0x7F13006E);  // string:album_detail_title_video "이 앨범의 비디오"
    }
    ...
    public void itemClickLog(@Nullable VIDEO detailBaseRes$VIDEO0, int v) {
        ...
        if(f0 != null) {
            ...
            f0.y = this.getString(0x7F130DE1);  // string:tiara_common_layer1_album_video "이앨범의비디오"
            f0.c(v + 1);
            String s = "";
    ...
    @NotNull
    public static final AlbumVideoHolder newInstance(@NotNull ViewGroup viewGroup0, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
        return AlbumVideoHolder.Companion.newInstance(viewGroup0, onViewHolderActionBaseListener0);
    }
        ...
        if(mainTabTitleView2 != null) {
            mainTabTitleView2.setOnEventListener(new SimpleEventListener() {
                ...
                public void onViewAllButtonClick(View view0) {
                    q.g(view0, "view");
                    Navigator.open(AlbumDetailContentsMvFragment.Companion.newInstance(this.getContentId()));
                    f f0 = AlbumVideoHolder.this.getOnViewHolderActionListener().onTiaraEventBuilder();
                    if(f0 != null) {
                        f0.a = AlbumVideoHolder.this.getString(0x7F130DC9);  // string:tiara_common_action_name_move_page "페이지이동"
                        f0.y = AlbumVideoHolder.this.getString(0x7F130DE1);  // string:tiara_common_layer1_album_video "이앨범의비디오"
                        f0.F = AlbumVideoHolder.this.getString(0x7F130DB1);  // string:tiara_click_copy_view_all "전체보기"
                        f0.a().track();
                    }
                }
            });
