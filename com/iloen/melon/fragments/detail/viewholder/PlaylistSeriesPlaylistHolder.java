...
public final class PlaylistSeriesPlaylistHolder extends PlaylistHolder {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final PlaylistSeriesPlaylistHolder newInstance(@NotNull ViewGroup viewGroup0, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
            q.g(viewGroup0, "parent");
            q.g(onViewHolderActionBaseListener0, "onViewHolderActionListener");
            return new PlaylistSeriesPlaylistHolder(e0.a(LayoutInflater.from(viewGroup0.getContext()), viewGroup0), onViewHolderActionBaseListener0);
        }
    }
    ...
    static {
        PlaylistSeriesPlaylistHolder.Companion = new Companion(null);
        PlaylistSeriesPlaylistHolder.$stable = 8;
    }

    public PlaylistSeriesPlaylistHolder(@NotNull e0 e00, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
        q.g(e00, "bind");
        q.g(onViewHolderActionBaseListener0, "onViewHolderActionListener");
    ...
    public String getTitleName() {
        return this.getString(0x7F13034C);  // string:dj_playlist_title_series_playlist "이 플레이리스트의 시리즈"
    }
    ...
    public void itemClickLog(@NotNull ActionKind actionKind0, @NotNull String s, int v, @Nullable PLAYLIST detailBaseRes$PLAYLIST0) {
        ...
        if(f0 != null) {
            f0.d = actionKind0;
            f0.a = s;
            f0.y = this.getString(0x7F130E69);  // string:tiara_djplaylist_layer1_series_playlist "이플레이리스트의 시리즈"
            f0.c(v + 1);
            String s1 = null;
    ...
    @NotNull
    public static final PlaylistSeriesPlaylistHolder newInstance(@NotNull ViewGroup viewGroup0, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
        return PlaylistSeriesPlaylistHolder.Companion.newInstance(viewGroup0, onViewHolderActionBaseListener0);
    }
        ...
        if(mainTabTitleView0 != null) {
            mainTabTitleView0.setOnEventListener(new SimpleEventListener() {
                ...
                public void onViewAllButtonClick(View view0) {
                    q.g(view0, "view");
                    Navigator.INSTANCE.openSeriesFolderDetail(this.getContentId());
                    f f0 = PlaylistSeriesPlaylistHolder.this.getOnViewHolderActionListener().onTiaraEventBuilder();
                    if(f0 != null) {
                        f0.d = ActionKind.ClickContent;
                        f0.a = PlaylistSeriesPlaylistHolder.this.getString(0x7F130DC9);  // string:tiara_common_action_name_move_page "페이지이동"
                        f0.F = PlaylistSeriesPlaylistHolder.this.getString(0x7F130DB1);  // string:tiara_click_copy_view_all "전체보기"
                        f0.y = PlaylistSeriesPlaylistHolder.this.getString(0x7F130E69);  // string:tiara_djplaylist_layer1_series_playlist "이플레이리스트의 시리즈"
                        f0.a().track();
                    }
                }
            });
