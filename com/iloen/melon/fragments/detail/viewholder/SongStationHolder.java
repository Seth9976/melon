...
public final class SongStationHolder extends StationHolder {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final SongStationHolder newInstance(@NotNull ViewGroup viewGroup0, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
            q.g(viewGroup0, "parent");
            q.g(onViewHolderActionBaseListener0, "onViewHolderActionListener");
            return new SongStationHolder(h0.a(LayoutInflater.from(viewGroup0.getContext()), viewGroup0), onViewHolderActionBaseListener0);
        }
    }
    ...
    @NotNull
    public static final String TAG = "SongStationHolder";

    static {
        SongStationHolder.Companion = new Companion(null);
        SongStationHolder.$stable = 8;
    }

    public SongStationHolder(@NotNull h0 h00, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
        q.g(h00, "bind");
        q.g(onViewHolderActionBaseListener0, "onViewHolderActionListener");
    ...
    public String getTitleName() {
        return this.getString(0x7F130A88);  // string:song_detail_title_station "이 곡의 스테이션"
    }
    ...
    public void itemClickLog(@NotNull ActionKind actionKind0, @NotNull String s, int v, @Nullable STATION detailBaseRes$STATION0) {
        ...
        if(f0 != null) {
            f0.a = s;
            f0.d = actionKind0;
            f0.y = this.getString(0x7F130E17);  // string:tiara_common_layer1_song_station "이곡의스테이션"
            f0.c(v + 1);
            String s1 = null;
            f0.o = detailBaseRes$STATION0 == null ? null : detailBaseRes$STATION0.castSeq;
            f0.p = this.getString(0x7F130F01);  // string:tiara_meta_type_song "곡"
            f0.q = detailBaseRes$STATION0 == null ? null : detailBaseRes$STATION0.castTitle;
    ...
    @NotNull
    public static final SongStationHolder newInstance(@NotNull ViewGroup viewGroup0, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
        return SongStationHolder.Companion.newInstance(viewGroup0, onViewHolderActionBaseListener0);
    }
        ...
        if(mainTabTitleView2 != null) {
            mainTabTitleView2.setOnEventListener(new SimpleEventListener() {
                ...
                public void onViewAllButtonClick(View view0) {
                    q.g(view0, "view");
                    Navigator.INSTANCE.openSongStation(this.getContentId());
                    f f0 = SongStationHolder.this.getOnViewHolderActionListener().onTiaraEventBuilder();
                    if(f0 != null) {
                        f0.a = SongStationHolder.this.getString(0x7F130DC9);  // string:tiara_common_action_name_move_page "페이지이동"
                        f0.y = SongStationHolder.this.getString(0x7F130E17);  // string:tiara_common_layer1_song_station "이곡의스테이션"
                        f0.F = SongStationHolder.this.getString(0x7F130DB1);  // string:tiara_click_copy_view_all "전체보기"
                        f0.a().track();
                    }
                }
            });
