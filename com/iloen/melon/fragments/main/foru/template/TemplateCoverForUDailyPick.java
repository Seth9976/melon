...
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000E\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000B\n\u0002\b\u0005\b\u0007\u0018\u0000 \u001C2\u00020\u0001:\u0001\u001CB\u000F\u0012\u0006\u0010\u0003\u001A\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0017\u0010\t\u001A\u00020\b2\u0006\u0010\u0007\u001A\u00020\u0006H\u0016¢\u0006\u0004\b\t\u0010\nJ\u000F\u0010\f\u001A\u00020\u000BH\u0014¢\u0006\u0004\b\f\u0010\rJ\u000F\u0010\u000F\u001A\u00020\u000EH\u0016¢\u0006\u0004\b\u000F\u0010\u0010J\u001F\u0010\u0013\u001A\u0012\u0012\u0004\u0012\u00020\u000B0\u0011j\b\u0012\u0004\u0012\u00020\u000B`\u0012H\u0014¢\u0006\u0004\b\u0013\u0010\u0014J\u0015\u0010\u0015\u001A\u00020\b2\u0006\u0010\u0007\u001A\u00020\u0006¢\u0006\u0004\b\u0015\u0010\nR\u0016\u0010\u0016\u001A\u00020\u000B8\u0002@\u0002X\u0082\u000E¢\u0006\u0006\n\u0004\b\u0016\u0010\u0017R\u0016\u0010\u0019\u001A\u00020\u00188\u0002@\u0002X\u0082\u000E¢\u0006\u0006\n\u0004\b\u0019\u0010\u001AR\u0016\u0010\u001B\u001A\u00020\u00188\u0002@\u0002X\u0082\u000E¢\u0006\u0006\n\u0004\b\u001B\u0010\u001A¨\u0006\u001D"}, d2 = {"Lcom/iloen/melon/fragments/main/foru/template/TemplateCoverForUDailyPick;", "Lcom/iloen/melon/utils/template/TemplateCoverBase;", "Lcom/iloen/melon/utils/template/TemplateData;", "templateData", "<init>", "(Lcom/iloen/melon/utils/template/TemplateData;)V", "Lcom/iloen/melon/utils/template/TemplateImageLoader$DownloadStateListener;", "listener", "Lie/H;", "load", "(Lcom/iloen/melon/utils/template/TemplateImageLoader$DownloadStateListener;)V", "", "getLayoutResId", "()I", "", "getTemplateCacheKey", "()Ljava/lang/String;", "Ljava/util/ArrayList;", "Lkotlin/collections/ArrayList;", "getViewIds", "()Ljava/util/ArrayList;", "checkDownloadCompleted", "downCnt", "I", "", "imageAllCanceled", "Z", "enableCache", "Companion", "app_playstoreProdRelease"}, k = 1, mv = {2, 2, 0}, xi = 0x30)
public final class TemplateCoverForUDailyPick extends TemplateCoverBase {
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000E\n\u0000\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000E\u0010\u0004\u001A\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000R\u000E\u0010\u0006\u001A\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000¨\u0006\b"}, d2 = {"Lcom/iloen/melon/fragments/main/foru/template/TemplateCoverForUDailyPick$Companion;", "", "<init>", "()V", "TAG", "", "STANDARD_SIZE_144_MIN", "", "app_playstoreProdRelease"}, k = 1, mv = {2, 2, 0}, xi = 0x30)
    ...
    @NotNull
    private static final String TAG = "TemplateCoverForUDailyPick";
    private int downCnt;
    private boolean enableCache;
    private boolean imageAllCanceled;

    static {
        TemplateCoverForUDailyPick.Companion = new Companion(null);
        TemplateCoverForUDailyPick.$stable = 8;
    }

    public TemplateCoverForUDailyPick(@NotNull TemplateData templateData0) {
    ...
    public final void checkDownloadCompleted(@NotNull DownloadStateListener templateImageLoader$DownloadStateListener0) {
        ...
        TextView textView0 = (TextView)this.templateView.findViewById(0x7F0A0D22);  // id:tv_tag
        TextView textView1 = (TextView)this.templateView.findViewById(0x7F0A0C12);  // id:tv_artist
        String s = this.standardSizeDp > 144.0f ? this.getTitleLine2() : this.getTitleLine1();
        ...
        if(!TextUtils.isEmpty(this.getSubTitle())) {
            ...
            ViewUtils.setText(textView1, this.getSubTitle());
        }
        if(this.imageAllCanceled) {
            if(textView0 != null) {
            ...
            if(textView1 != null) {
                textView1.setTextColor(ColorUtils.getColor(this.context, 0x7F060172));  // color:gray990s
            }
    ...
    public int getLayoutResId() {
        return this.standardSizeDp > 144.0f ? 0x7F0D01BB : 0x7F0D01BA;  // layout:cover_template_foru_daily_pick_200
    }

    @Override  // com.iloen.melon.utils.template.TemplateCoverBase
    @NotNull
    public String getTemplateCacheKey() {
        StringBuilder stringBuilder0 = new StringBuilder("TemplateCoverForUDailyPick");
