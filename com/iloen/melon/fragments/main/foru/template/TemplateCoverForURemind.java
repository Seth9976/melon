...
public final class TemplateCoverForURemind extends TemplateCoverBase {
    ...
    @NotNull
    private static final String TAG = "TemplateCoverForURemind";
    private int downCnt;
    private boolean loadFailed;

    static {
        TemplateCoverForURemind.Companion = new Companion(null);
        TemplateCoverForURemind.$stable = 8;
    }

    public TemplateCoverForURemind(@NotNull TemplateData templateData0) {
    ...
    public int getLayoutResId() {
        return this.standardSizeDp > 144.0f ? 0x7F0D01CF : 0x7F0D01CE;  // layout:cover_template_foru_remind_200
    }

    @Override  // com.iloen.melon.utils.template.TemplateCoverBase
    @NotNull
    public String getTemplateCacheKey() {
        StringBuilder stringBuilder0 = new StringBuilder("TemplateCoverForURemind");
