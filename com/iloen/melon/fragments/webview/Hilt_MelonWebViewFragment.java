...
abstract class Hilt_MelonWebViewFragment extends MetaContentBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_MelonWebViewFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((MelonWebViewFragment_GeneratedInjector)this.generatedComponent()).injectMelonWebViewFragment(((MelonWebViewFragment)this));
        }
    }
