...
public final class ArtistStationHolder extends StationHolder {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final ArtistStationHolder newInstance(@NotNull ViewGroup viewGroup0, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
            q.g(viewGroup0, "parent");
            q.g(onViewHolderActionBaseListener0, "onViewHolderActionListener");
            return new ArtistStationHolder(h0.a(LayoutInflater.from(viewGroup0.getContext()), viewGroup0), onViewHolderActionBaseListener0);
        }
    }
    ...
    static {
        ArtistStationHolder.Companion = new Companion(null);
        ArtistStationHolder.$stable = 8;
    }

    public ArtistStationHolder(@NotNull h0 h00, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
        q.g(h00, "bind");
        q.g(onViewHolderActionBaseListener0, "onViewHolderActionListener");
    ...
    public void itemClickLog(@NotNull ActionKind actionKind0, @NotNull String s, int v, @Nullable STATION detailBaseRes$STATION0) {
        ...
        if(f0 != null) {
            f0.a = s;
            f0.d = actionKind0;
            f0.y = this.getString(0x7F130E1A);  // string:tiara_common_layer1_station "스테이션"
            f0.c(v + 1);
            String s1 = null;
    ...
    @NotNull
    public static final ArtistStationHolder newInstance(@NotNull ViewGroup viewGroup0, @NotNull OnViewHolderActionBaseListener onViewHolderActionBaseListener0) {
        return ArtistStationHolder.Companion.newInstance(viewGroup0, onViewHolderActionBaseListener0);
    }
        ...
        if(mainTabTitleView0 != null) {
            mainTabTitleView0.setOnEventListener(new SimpleEventListener() {
                ...
                public void onViewAllButtonClick(View view0) {
                    q.g(view0, "view");
                    Navigator.open(ArtistDetailContentsStationFragment.Companion.newInstance(this.getContentId()));
                    f f0 = ArtistStationHolder.this.getOnViewHolderActionListener().onTiaraEventBuilder();
                    if(f0 != null) {
                        f0.a = ArtistStationHolder.this.getString(0x7F130DC9);  // string:tiara_common_action_name_move_page "페이지이동"
                        f0.y = ArtistStationHolder.this.getString(0x7F130E1A);  // string:tiara_common_layer1_station "스테이션"
                        f0.F = ArtistStationHolder.this.getString(0x7F130DB1);  // string:tiara_click_copy_view_all "전체보기"
                        f0.a().track();
                    }
                }
            });
