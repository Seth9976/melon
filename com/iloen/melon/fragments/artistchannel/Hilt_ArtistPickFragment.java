...
public abstract class Hilt_ArtistPickFragment extends MetaContentBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_ArtistPickFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((ArtistPickFragment_GeneratedInjector)this.generatedComponent()).injectArtistPickFragment(((ArtistPickFragment)this));
        }
    }
