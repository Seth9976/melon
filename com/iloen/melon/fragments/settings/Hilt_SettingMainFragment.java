...
public abstract class Hilt_SettingMainFragment extends MetaContentBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_SettingMainFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((SettingMainFragment_GeneratedInjector)this.generatedComponent()).injectSettingMainFragment(((SettingMainFragment)this));
        }
    }
