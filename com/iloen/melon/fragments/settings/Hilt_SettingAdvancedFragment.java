...
abstract class Hilt_SettingAdvancedFragment extends SettingBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_SettingAdvancedFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((SettingAdvancedFragment_GeneratedInjector)this.generatedComponent()).injectSettingAdvancedFragment(((SettingAdvancedFragment)this));
        }
    }
