...
public abstract class Hilt_SettingMusicAlarmListFragment extends SettingBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_SettingMusicAlarmListFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((SettingMusicAlarmListFragment_GeneratedInjector)this.generatedComponent()).injectSettingMusicAlarmListFragment(((SettingMusicAlarmListFragment)this));
        }
    }
