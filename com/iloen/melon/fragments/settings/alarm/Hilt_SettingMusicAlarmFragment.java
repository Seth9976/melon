...
public abstract class Hilt_SettingMusicAlarmFragment extends SettingBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_SettingMusicAlarmFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((SettingMusicAlarmFragment_GeneratedInjector)this.generatedComponent()).injectSettingMusicAlarmFragment(((SettingMusicAlarmFragment)this));
        }
    }
