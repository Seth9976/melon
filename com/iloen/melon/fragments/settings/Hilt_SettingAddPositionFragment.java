...
public abstract class Hilt_SettingAddPositionFragment extends SettingBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_SettingAddPositionFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((SettingAddPositionFragment_GeneratedInjector)this.generatedComponent()).injectSettingAddPositionFragment(((SettingAddPositionFragment)this));
        }
    }
