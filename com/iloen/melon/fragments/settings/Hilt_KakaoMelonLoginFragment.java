...
public abstract class Hilt_KakaoMelonLoginFragment extends SettingBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_KakaoMelonLoginFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((KakaoMelonLoginFragment_GeneratedInjector)this.generatedComponent()).injectKakaoMelonLoginFragment(((KakaoMelonLoginFragment)this));
        }
    }
