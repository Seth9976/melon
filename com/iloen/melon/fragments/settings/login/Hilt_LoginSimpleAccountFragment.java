...
public abstract class Hilt_LoginSimpleAccountFragment extends SettingBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_LoginSimpleAccountFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((LoginSimpleAccountFragment_GeneratedInjector)this.generatedComponent()).injectLoginSimpleAccountFragment(((LoginSimpleAccountFragment)this));
        }
    }
