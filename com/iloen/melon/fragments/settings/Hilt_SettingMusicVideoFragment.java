...
abstract class Hilt_SettingMusicVideoFragment extends SettingBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_SettingMusicVideoFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((SettingMusicVideoFragment_GeneratedInjector)this.generatedComponent()).injectSettingMusicVideoFragment(((SettingMusicVideoFragment)this));
        }
    }
