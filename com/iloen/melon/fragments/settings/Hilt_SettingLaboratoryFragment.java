...
public abstract class Hilt_SettingLaboratoryFragment extends SettingBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_SettingLaboratoryFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((SettingLaboratoryFragment_GeneratedInjector)this.generatedComponent()).injectSettingLaboratoryFragment(((SettingLaboratoryFragment)this));
        }
    }
