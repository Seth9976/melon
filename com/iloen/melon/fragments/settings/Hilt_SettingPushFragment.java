...
abstract class Hilt_SettingPushFragment extends SettingBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_SettingPushFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((SettingPushFragment_GeneratedInjector)this.generatedComponent()).injectSettingPushFragment(((SettingPushFragment)this));
        }
    }
