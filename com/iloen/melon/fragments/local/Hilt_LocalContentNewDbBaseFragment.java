...
public abstract class Hilt_LocalContentNewDbBaseFragment extends DetailMetaContentBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_LocalContentNewDbBaseFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((LocalContentNewDbBaseFragment_GeneratedInjector)this.generatedComponent()).injectLocalContentNewDbBaseFragment(((LocalContentNewDbBaseFragment)this));
        }
    }
