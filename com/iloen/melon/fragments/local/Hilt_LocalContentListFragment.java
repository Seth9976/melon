...
public abstract class Hilt_LocalContentListFragment extends MetaContentBaseFragment {
    private ContextWrapper componentContext;
    private boolean disableGetContextFix;
    private boolean injected;

    public Hilt_LocalContentListFragment() {
        this.injected = false;
    }
    ...
    public void inject() {
        if(!this.injected) {
            this.injected = true;
            ((LocalContentListFragment_GeneratedInjector)this.generatedComponent()).injectLocalContentListFragment(((LocalContentListFragment)this));
        }
    }
