...
public abstract class j extends y implements ListMarker, d, h {
    ...
    public j(Context context0, List list0) {
    ...
    public void addAll(Collection collection0) {
        if(collection0 == null) {
            LogU.e("ListMarkerRecyclerViewArrayAdapter", "addAll() - null collection");
            return;
        }
    ...
    public void addAll(Collection collection0, boolean z) {
        ...
        super.addAll(collection0, z);
    }

    @Override  // com.iloen.melon.adapters.common.y
    public void addAll(Object[] arr_object) {
        if(arr_object == null) {
            LogU.e("ListMarkerRecyclerViewArrayAdapter", "addAll() - null items");
            return;
        }
            ...
            if(!TextUtils.isEmpty(this.mKeyName)) {
                ...
                if(object0 != null) {
                    try {
                        ...
                        LogU.w("ListMarkerRecyclerViewArrayAdapter", "getKey() IllegalArgumentException:" + illegalArgumentException0.toString());
                        return null;
                    }
                    catch(IllegalAccessException illegalAccessException0) {
                        LogU.w("ListMarkerRecyclerViewArrayAdapter", "getKey() IllegalAccessException:" + illegalAccessException0.toString());
                        return null;
                    }
                    LogU.w("ListMarkerRecyclerViewArrayAdapter", "getKey() NoSuchFieldException:" + noSuchFieldException0.toString());
                    return null;
                }
            }
        }
        ...
        if(!this.isEmpty()) {
            ...
            for(int v1 = 0; v1 < v; ++v1) {
                if(s.equalsIgnoreCase(this.getKey(v1))) {
                    LogU.d("ListMarkerRecyclerViewArrayAdapter", "getWeakMarked(" + v1 + ") key:" + s);
                    return v1;
                }
            }
        }
    ...
    public boolean isMarked(int v) {
        if(this.isEmpty()) {
            LogU.w("ListMarkerRecyclerViewArrayAdapter", "isMarked() invalid objects");
            return false;
        }
        if(v >= 0 && v < this.getCount()) {
            String s = this.getKey(v);
            if(TextUtils.isEmpty(s)) {
                LogU.w("ListMarkerRecyclerViewArrayAdapter", "isMarked() invalid key");
                return false;
            }
        ...
        LogU.w("ListMarkerRecyclerViewArrayAdapter", "isMarked() invalid position");
        return false;
    }
    ...
    public void setLastMarkedPosition(int v, boolean z) {
        if(this.isEmpty()) {
            LogU.w("ListMarkerRecyclerViewArrayAdapter", "setLastMarkedPosition() - invalid objects");
            return;
        }
        if(v >= 0 && v < this.getCount()) {
            if(z) {
        ...
        LogU.w("ListMarkerRecyclerViewArrayAdapter", "setLastMarkedPosition() - invalid position");
    }
    ...
    public void setMarked(int v, boolean z) {
        if(this.isEmpty()) {
            LogU.w("ListMarkerRecyclerViewArrayAdapter", "setMarked() invalid objects");
            return;
        }
        if(v >= 0 && v < this.getCount()) {
            String s = this.getKey(v);
            if(TextUtils.isEmpty(s)) {
                LogU.w("ListMarkerRecyclerViewArrayAdapter", "setMarked() invalid key");
                return;
            }
        ...
        LogU.w("ListMarkerRecyclerViewArrayAdapter", "setMarked() invalid position");
    }
