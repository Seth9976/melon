...
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/iloen/melon/sns/model/SharableMemorialCard;", "Lcom/iloen/melon/sns/model/SharableBase;", "app_playstoreProdRelease"}, k = 1, mv = {2, 2, 0}, xi = 0x30)
public final class SharableMemorialCard extends SharableBase {
    ...
    static {
        SharableMemorialCard.CREATOR = new e(23);
    }
    ...
    public final String getDefaultShareLinkPageUrl(SnsTarget snsTarget0) {
        ...
        d.u(stringBuilder0, this.a, "&shareType=MEMORIAL_CARD&ref=", s, "&kageAccessKey=");
    ...
    public final String getDisplayMessage(SnsTarget snsTarget0) {
        ...
        if(context0 != null) {
            ...
            return this.makeMessage(snsTarget0, String.format(l1.m(s, "getTextLimitForLength(...)", context0, 0x7F130A58, "getString(...)"), Arrays.copyOf(new Object[]{s}, 1)));  // string:sns_share_type_memorial_card "%1$s님과 기억하고 싶은 순간들을 만나보세요!"
        }
        return null;
    }
