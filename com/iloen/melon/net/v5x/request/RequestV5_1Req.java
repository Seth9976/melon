...
public abstract class RequestV5_1Req extends HttpRequest {
    public RequestV5_1Req(Context context0, int v, Class class0) {
        super(context0, v, class0);
        this.setInitParam(context0, true);
    }

    public RequestV5_1Req(Context context0, int v, Class class0, boolean z) {
        super(context0, v, class0);
        this.setInitParam(context0, z);
    }

    public RequestV5_1Req(Context context0, String s, String s1, int v, Class class0) {
