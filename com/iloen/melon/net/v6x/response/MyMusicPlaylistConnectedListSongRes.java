...
public class MyMusicPlaylistConnectedListSongRes extends ResponseV6Res implements ResponseAdapter {
    ...
    public Collection getItems() {
        ...
        RESPONSE myMusicPlaylistConnectedListSongRes$RESPONSE0 = this.response;
        if(myMusicPlaylistConnectedListSongRes$RESPONSE0 != null) {
            ArrayList arrayList0 = myMusicPlaylistConnectedListSongRes$RESPONSE0.songList;
            if(arrayList0 != null) {
    ...
    public StatsElementsBase getStatsElements() {
        RESPONSE myMusicPlaylistConnectedListSongRes$RESPONSE0 = this.response;
        return myMusicPlaylistConnectedListSongRes$RESPONSE0 != null ? myMusicPlaylistConnectedListSongRes$RESPONSE0.statsElements : null;
    }
