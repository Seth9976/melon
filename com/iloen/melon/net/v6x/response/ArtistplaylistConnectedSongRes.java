...
public class ArtistplaylistConnectedSongRes extends ResponseV6Res implements ResponseAdapter {
    ...
    public Collection getItems() {
        ...
        RESPONSE artistplaylistConnectedSongRes$RESPONSE0 = this.response;
        if(artistplaylistConnectedSongRes$RESPONSE0 != null) {
            ArrayList arrayList0 = artistplaylistConnectedSongRes$RESPONSE0.songList;
            if(arrayList0 != null) {
    ...
    public StatsElementsBase getStatsElements() {
        RESPONSE artistplaylistConnectedSongRes$RESPONSE0 = this.response;
        return artistplaylistConnectedSongRes$RESPONSE0 != null ? artistplaylistConnectedSongRes$RESPONSE0.statsElements : null;
    }
