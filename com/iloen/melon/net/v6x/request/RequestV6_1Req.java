...
public abstract class RequestV6_1Req extends HttpRequest {
    public RequestV6_1Req(int v, Class class0) {
        super(v, class0);
        this.setInitParam(MelonAppBase.instance.getContext(), true);
    }

    public RequestV6_1Req(Context context0, int v, Class class0) {
        super(context0, v, class0);
        this.setInitParam(context0, true);
    }

    public RequestV6_1Req(Context context0, int v, Class class0, boolean z) {
        super(context0, v, class0);
        this.setInitParam(context0, z);
    }

    public RequestV6_1Req(Context context0, String s, String s1, int v, Class class0) {
