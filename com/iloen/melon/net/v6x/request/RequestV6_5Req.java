...
public abstract class RequestV6_5Req extends HttpRequest {
    public RequestV6_5Req(Context context0, int v, Class class0) {
        super(context0, v, class0);
        this.setInitParam(context0, true);
    }

    public RequestV6_5Req(Context context0, int v, Class class0, boolean z) {
        super(context0, v, class0);
        this.setInitParam(context0, z);
    }

    public RequestV6_5Req(Context context0, String s, String s1, int v, Class class0) {
