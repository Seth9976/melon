...
public abstract class Hilt_VideoMainFrameFragment extends FloatingFragment implements b {
    ...
    public Hilt_VideoMainFrameFragment() {
        this.d = new Object();
        this.e = false;
    }
    ...
    public void inject() {
        if(!this.e) {
            this.e = true;
            ((VideoMainFrameFragment_GeneratedInjector)this.generatedComponent()).injectVideoMainFrameFragment(((VideoMainFrameFragment)this));
        }
    }
