...
public abstract class Hilt_MusicSmartPlaylistViewPagerFragment extends PlaylistViewPagerBaseFragment implements b {
    ...
    public Hilt_MusicSmartPlaylistViewPagerFragment() {
        this.d = new Object();
        this.e = false;
    }
    ...
    public void inject() {
        if(!this.e) {
            this.e = true;
            ((MusicSmartPlaylistViewPagerFragment_GeneratedInjector)this.generatedComponent()).injectMusicSmartPlaylistViewPagerFragment(((MusicSmartPlaylistViewPagerFragment)this));
        }
    }
