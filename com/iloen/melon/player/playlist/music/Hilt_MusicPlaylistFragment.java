...
public abstract class Hilt_MusicPlaylistFragment extends MusicPlaylistBaseFragment {
    public ViewComponentManager.FragmentContextWrapper k;
    public boolean l;
    public boolean m;

    public Hilt_MusicPlaylistFragment() {
        this.m = false;
    }
    ...
    public void inject() {
        if(!this.m) {
            this.m = true;
            ((MusicPlaylistFragment_GeneratedInjector)this.generatedComponent()).injectMusicPlaylistFragment(((MusicPlaylistFragment)this));
        }
    }
