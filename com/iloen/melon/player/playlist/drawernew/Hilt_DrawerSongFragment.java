...
public abstract class Hilt_DrawerSongFragment extends o1 {
    public ViewComponentManager.FragmentContextWrapper a;
    public boolean b;
    public boolean c;

    public Hilt_DrawerSongFragment() {
        this.c = false;
    }
    ...
    public void inject() {
        if(!this.c) {
            this.c = true;
            ((DrawerSongFragment_GeneratedInjector)this.generatedComponent()).injectDrawerSongFragment(((DrawerSongFragment)this));
        }
    }
