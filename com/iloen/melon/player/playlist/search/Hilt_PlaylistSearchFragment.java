...
public abstract class Hilt_PlaylistSearchFragment extends J0 {
    public ViewComponentManager.FragmentContextWrapper a;
    public boolean b;
    public boolean c;

    public Hilt_PlaylistSearchFragment() {
        this.c = false;
    }
    ...
    public void inject() {
        if(!this.c) {
            this.c = true;
            ((PlaylistSearchFragment_GeneratedInjector)this.generatedComponent()).injectPlaylistSearchFragment(((PlaylistSearchFragment)this));
        }
    }
