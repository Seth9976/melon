...
public abstract class Hilt_MixUpPlaylistViewPagerFragment extends PlaylistViewPagerBaseFragment implements b {
    ...
    public Hilt_MixUpPlaylistViewPagerFragment() {
        this.d = new Object();
        this.e = false;
    }
    ...
    public void inject() {
        if(!this.e) {
            this.e = true;
            ((MixUpPlaylistViewPagerFragment_GeneratedInjector)this.generatedComponent()).injectMixUpPlaylistViewPagerFragment(((MixUpPlaylistViewPagerFragment)this));
        }
    }
