...
public abstract class Hilt_MixUpPlaylistComposeFragment extends J0 {
    public ViewComponentManager.FragmentContextWrapper a;
    public boolean b;
    public boolean c;

    public Hilt_MixUpPlaylistComposeFragment() {
        this.c = false;
    }
    ...
    public void inject() {
        if(!this.c) {
            this.c = true;
            ((MixUpPlaylistComposeFragment_GeneratedInjector)this.generatedComponent()).injectMixUpPlaylistComposeFragment(((MixUpPlaylistComposeFragment)this));
        }
    }
