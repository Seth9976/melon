...
public abstract class Hilt_PlaylistMainFragment extends J0 {
    public ViewComponentManager.FragmentContextWrapper a;
    public boolean b;
    public boolean c;

    public Hilt_PlaylistMainFragment() {
        this.c = false;
    }
    ...
    public void inject() {
        if(!this.c) {
            this.c = true;
            ((PlaylistMainFragment_GeneratedInjector)this.generatedComponent()).injectPlaylistMainFragment(((PlaylistMainFragment)this));
        }
    }
