...
public abstract class Hilt_InstantPlayPopup extends w implements b {
    ...
    public void inject() {
        if(!this.e) {
            this.e = true;
            ((InstantPlayPopup_GeneratedInjector)this.generatedComponent()).injectInstantPlayPopup(((InstantPlayPopup)this));
        }
    }
