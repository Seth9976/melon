...
public final class LocalPlaylistDatabase_Impl extends LocalPlaylistDatabase {
    ...
    public final void clearAllTables() {
        this.performClear(false, new String[]{"local_playlists", "local_playlists_map"});
    }

    @Override  // androidx.room.H
    public final l createInvalidationTracker() {
        return new l(this, new HashMap(0), new HashMap(0), new String[]{"local_playlists", "local_playlists_map"});
    }
    ...
    public final Map getRequiredTypeConverters() {
        ...
        ((HashMap)map0).put(q.class, Collections.EMPTY_LIST);
        return map0;
    }
}
