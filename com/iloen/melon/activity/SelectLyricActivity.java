...
import b.a;
import com.iloen.melon.fragments.artistchannel.NowPlayingSelectLyric;

public class SelectLyricActivity extends PopupFragmentActivity {
    @Override  // com.iloen.melon.activity.PopupFragmentActivity
    public I getAddFragment() {
        Intent intent0 = this.getIntent();
        return intent0 != null ? NowPlayingSelectLyric.newInstance(intent0.getStringExtra("argSongId")) : null;
    }
