...
final class zzek extends zzdr implements zzez, zzge, RandomAccess {
    private static final zzek zza;
    private double[] zzb;
    private int zzc;

    static {
        zzek.zza = new zzek(new double[0], 0, false);
    }
    ...
    private zzek(double[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final boolean add(Object object0) {
        this.zze(((double)(((Double)object0))));
        return true;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzek)) {
            return super.addAll(collection0);
        }
        int v = ((zzek)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzek)collection0).zzb, 0, this.zzb, this.zzc, ((zzek)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzek)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzek)object0).zzc) {
            return false;
        }
        double[] arr_f = ((zzek)object0).zzb;
    ...
    public final zzez zzd(int v) {
        ...
        return new zzek(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }

    public final void zze(double f) {
        this.zza();
        int v = this.zzc;
        double[] arr_f = this.zzb;
        if(v == arr_f.length) {
