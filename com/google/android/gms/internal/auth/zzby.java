...
public enum zzby {
    ...
    private zzby(String s1) {
        this.zzak = s1;
    }

    public static final zzby zza(String s) {
        zzby[] arr_zzby = zzby.values();
        for(int v = 0; v < arr_zzby.length; ++v) {
            zzby zzby0 = arr_zzby[v];
            if(zzby0.zzak.equals(s)) {
                return zzby0;
            }
        }
        return zzby.zzo;
