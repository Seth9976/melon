...
public enum zzpb {
    ...
    START_DISCOVERY_AFTER_FIRST_TAP_ON_CAST_BUTTON(0x1F),
    CAST_UNAVAILABLE_BUTTON_VISIBLE(0x20),
    ...
    HLS_VIDEO_SEGMENT_MAP_HLS_VIDEO_SEGMENT_FORMAT_STRING_TO_ENUM(0x2F),
    CAST_SLIDER_SET_AD_BLOCK_POSITIONS(0x30),
    ...
    public final String toString() {
        return Integer.toString(this.zzah);
    }
