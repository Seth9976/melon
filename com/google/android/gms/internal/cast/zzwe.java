...
final class zzwe extends zzwc implements zzxn, RandomAccess {
    ...
    static {
        ...
        zzwe.zza = arr_z;
        new zzwe(arr_z, 0, false);
    }

    public zzwe() {
        this(zzwe.zza, 0, true);
    }

    private zzwe(boolean[] arr_z, int v, boolean z) {
        super(z);
        this.zzb = arr_z;
        this.zzc = v;
    }
        ...
        if(v >= 0) {
            ...
            if(v <= v1) {
                ...
                if(v1 < arr_z.length) {
                    ...
                    boolean[] arr_z1 = new boolean[zzwe.zzf(arr_z.length)];
    ...
    public final boolean add(Object object0) {
        ...
        if(this.zzc == v) {
            boolean[] arr_z = new boolean[zzwe.zzf(v)];
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzwe)) {
            return super.addAll(collection0);
        }
        int v = ((zzwe)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzwe)collection0).zzb, 0, this.zzb, this.zzc, ((zzwe)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzwe)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzwe)object0).zzc) {
            return false;
        }
        boolean[] arr_z = ((zzwe)object0).zzb;
    ...
    public final int hashCode() {
        int v1 = 1;
        for(int v = 0; v < this.zzc; ++v) {
            v1 = v1 * 0x1F + zzxo.zza(this.zzb[v]);
        }
        return v1;
    }
    ...
    public final zzxn zzd(int v) {
        ...
        return v == 0 ? new zzwe(zzwe.zza, this.zzc, true) : new zzwe(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
