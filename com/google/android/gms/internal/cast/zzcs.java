...
public final class zzcs extends UIController implements ProgressListener {
    private final View zza;
    private final zza zzb;

    public zzcs(View view0, zza zza0) {
        this.zza = view0;
        this.zzb = zza0;
    ...
    public final void zza() {
        ...
        if(remoteMediaClient0 != null && remoteMediaClient0.hasMediaSession() && !remoteMediaClient0.isPlayingAd()) {
            ...
            if(remoteMediaClient0.zzw()) {
                long v = (long)this.zzb.zza();
                long v1 = this.zzb.zze();
                long v2 = (long)this.zzb.zzd();
                if(v1 + v - (this.zzb.zze() + v2) >= 10000L) {
                    z = true;
                }
            }
            view0.setEnabled(z);
