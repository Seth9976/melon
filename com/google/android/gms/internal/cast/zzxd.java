...
final class zzxd extends zzwc implements zzxn, RandomAccess {
    ...
    static {
        ...
        zzxd.zza = arr_f;
        new zzxd(arr_f, 0, false);
    }

    public zzxd() {
        this(zzxd.zza, 0, true);
    }

    private zzxd(float[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
        ...
        if(v >= 0) {
            ...
            if(v <= v1) {
                ...
                if(v1 < arr_f.length) {
                    ...
                    float[] arr_f1 = new float[zzxd.zzf(arr_f.length)];
    ...
    public final boolean add(Object object0) {
        ...
        if(this.zzc == v) {
            float[] arr_f = new float[zzxd.zzf(v)];
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzxd)) {
            return super.addAll(collection0);
        }
        int v = ((zzxd)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzxd)collection0).zzb, 0, this.zzb, this.zzc, ((zzxd)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzxd)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzxd)object0).zzc) {
            return false;
        }
        float[] arr_f = ((zzxd)object0).zzb;
    ...
    public final zzxn zzd(int v) {
        ...
        return v == 0 ? new zzxd(zzxd.zza, this.zzc, true) : new zzxd(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
