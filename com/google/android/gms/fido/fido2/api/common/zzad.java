...
@Class(creator = "GoogleSilentVerificationExtensionCreator")
public final class zzad extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR;
    @Field(getter = "getSilentVerification", id = 1)
    ...
    @Constructor
    public zzad(@Param(id = 1) boolean z) {
        this.zza = ((Boolean)Preconditions.checkNotNull(Boolean.valueOf(z))).booleanValue();
    }

    @Override
    public final boolean equals(Object object0) {
        return object0 instanceof zzad ? this.zza == ((zzad)object0).zza : false;
    }
