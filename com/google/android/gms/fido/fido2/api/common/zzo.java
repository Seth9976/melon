...
public final class zzo implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        while(parcel0.dataPosition() < v) {
            ...
            switch(((char)v1)) {
                case 2: {
                    publicKeyCredentialRequestOptions0 = (PublicKeyCredentialRequestOptions)SafeParcelReader.createParcelable(parcel0, v1, PublicKeyCredentialRequestOptions.CREATOR);
                    break;
                }
                case 3: {
