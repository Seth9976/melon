...
public class BrowserPublicKeyCredentialRequestOptions extends BrowserRequestOptions {
    ...
    @Constructor
    public BrowserPublicKeyCredentialRequestOptions(@Param(id = 2) PublicKeyCredentialRequestOptions publicKeyCredentialRequestOptions0, @Param(id = 3) Uri uri0, @Param(id = 4) byte[] arr_b) {
        this.zza = (PublicKeyCredentialRequestOptions)Preconditions.checkNotNull(publicKeyCredentialRequestOptions0);
