...
final class zzf implements VersionPolicy {
    ...
    public final SelectionResult selectModule(Context context0, String s, IVersions dynamiteModule$VersionPolicy$IVersions0) {
        ...
        int v = dynamiteModule$VersionPolicy$IVersions0.zza(context0, s, true);
        ...
        int v1 = dynamiteModule$VersionPolicy$IVersions0.zzb(context0, s);
        dynamiteModule$VersionPolicy$SelectionResult0.localVersion = v1;
        if(v1 != 0) {
            dynamiteModule$VersionPolicy$SelectionResult0.selection = -1;
        }
        return dynamiteModule$VersionPolicy$SelectionResult0;
