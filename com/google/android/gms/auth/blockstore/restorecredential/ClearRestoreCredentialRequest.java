...
@Class(creator = "ClearRestoreCredentialRequestCreator")
...
public final class ClearRestoreCredentialRequest extends AbstractSafeParcelable {
    ...
    static {
        ClearRestoreCredentialRequest.Companion = new Companion(null);
        ClearRestoreCredentialRequest.CREATOR = new ClearRestoreCredentialRequestCreator();
    }

    @Constructor
    public ClearRestoreCredentialRequest(@Param(id = 1) Bundle bundle0) {
    ...
    public void writeToParcel(Parcel parcel0, int v) {
        q.g(parcel0, "dest");
        ClearRestoreCredentialRequestCreator.writeToParcel(this, parcel0, v);
    }
}
