...
@Class(creator = "CreateRestoreCredentialRequestCreator")
...
public final class CreateRestoreCredentialRequest extends AbstractSafeParcelable {
    ...
    static {
        CreateRestoreCredentialRequest.Companion = new Companion(null);
        CreateRestoreCredentialRequest.CREATOR = new CreateRestoreCredentialRequestCreator();
    }

    @Constructor
    public CreateRestoreCredentialRequest(@Param(id = 1) Bundle bundle0) {
    ...
    public void writeToParcel(Parcel parcel0, int v) {
        q.g(parcel0, "dest");
        CreateRestoreCredentialRequestCreator.writeToParcel(this, parcel0, v);
    }
}
