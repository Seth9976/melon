...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000E\n\u0002\b\f\n\u0002\u0010\t\n\u0002\b\n\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000B\n\u0002\b\u0005\b\u0086\b\u0018\u00002\u00020\u0001R\u001A\u0010\u0003\u001A\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001A\u0004\b\u0005\u0010\u0006R\u001A\u0010\u0007\u001A\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0007\u0010\u0004\u001A\u0004\b\b\u0010\u0006R\u001C\u0010\t\u001A\u0004\u0018\u00010\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\t\u0010\u0004\u001A\u0004\b\n\u0010\u0006R\u001A\u0010\u000B\u001A\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u000B\u0010\u0004\u001A\u0004\b\f\u0010\u0006R\u001C\u0010\r\u001A\u0004\u0018\u00010\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\r\u0010\u0004\u001A\u0004\b\u000E\u0010\u0006R\u001C\u0010\u0010\u001A\u0004\u0018\u00010\u000F8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0010\u0010\u0011\u001A\u0004\b\u0012\u0010\u0013R\u001A\u0010\u0014\u001A\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0014\u0010\u0004\u001A\u0004\b\u0015\u0010\u0006R\u001A\u0010\u0016\u001A\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0016\u0010\u0004\u001A\u0004\b\u0017\u0010\u0006R\u001A\u0010\u0018\u001A\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0018\u0010\u0004\u001A\u0004\b\u0019\u0010\u0006R\u001A\u0010\u001B\u001A\u00020\u001A8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u001B\u0010\u001C\u001A\u0004\b\u001D\u0010\u001ER\u001A\u0010 \u001A\u00020\u001F8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b \u0010!\u001A\u0004\b\"\u0010#¨\u0006$"}, d2 = {"Lcom/kakaoent/leonchat/data/messages/UserJoinRoomMessageEntity;", "Lcom/kakaoent/leonchat/data/messages/UserJoinAndLeftRoomMessageEntity;", "", "type", "Ljava/lang/String;", "a", "()Ljava/lang/String;", "id", "c", "channelId", "getChannelId", "chatType", "getChatType", "sentTime", "getSentTime", "", "chatId", "Ljava/lang/Long;", "b", "()Ljava/lang/Long;", "message", "getMessage", "createdDt", "getCreatedDt", "roomId", "getRoomId", "Lcom/kakaoent/leonchat/data/messages/LeonUserInfo;", "fromUser", "Lcom/kakaoent/leonchat/data/messages/LeonUserInfo;", "getFromUser", "()Lcom/kakaoent/leonchat/data/messages/LeonUserInfo;", "", "broadcast", "Z", "getBroadcast", "()Z", "leonchat-android-sdk_release"}, k = 1, mv = {1, 7, 1}, xi = 0x30)
public final class UserJoinRoomMessageEntity extends UserJoinAndLeftRoomMessageEntity {
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof UserJoinRoomMessageEntity)) {
            return false;
        }
        if(!q.b(this.type, ((UserJoinRoomMessageEntity)object0).type)) {
            return false;
        }
        if(!q.b(this.id, ((UserJoinRoomMessageEntity)object0).id)) {
            return false;
        }
        if(!q.b(this.channelId, ((UserJoinRoomMessageEntity)object0).channelId)) {
            return false;
        }
        if(!q.b(this.chatType, ((UserJoinRoomMessageEntity)object0).chatType)) {
            return false;
        }
        if(!q.b(this.sentTime, ((UserJoinRoomMessageEntity)object0).sentTime)) {
            return false;
        }
        if(!q.b(this.chatId, ((UserJoinRoomMessageEntity)object0).chatId)) {
            return false;
        }
        if(!q.b(this.message, ((UserJoinRoomMessageEntity)object0).message)) {
            return false;
        }
        if(!q.b(this.createdDt, ((UserJoinRoomMessageEntity)object0).createdDt)) {
            return false;
        }
        if(!q.b(this.roomId, ((UserJoinRoomMessageEntity)object0).roomId)) {
            return false;
        }
        return q.b(this.fromUser, ((UserJoinRoomMessageEntity)object0).fromUser) ? this.broadcast == ((UserJoinRoomMessageEntity)object0).broadcast : false;
    }
    ...
    public final String toString() {
        StringBuilder stringBuilder0 = new StringBuilder("UserJoinRoomMessageEntity(type=");
