...
public class WebpDrawableTransformation implements Transformation {
    private final Transformation wrapped;

    public WebpDrawableTransformation(Transformation transformation0) {
    ...
    public boolean equals(Object object0) {
        return object0 instanceof WebpDrawableTransformation ? this.wrapped.equals(((WebpDrawableTransformation)object0).wrapped) : false;
    }
    ...
    public Resource transform(Context context0, Resource resource0, int v, int v1) {
        ...
        BitmapResource bitmapResource0 = new BitmapResource(webpDrawable0.getFirstFrame(), Glide.get(context0).getBitmapPool());
        ...
        webpDrawable0.setFrameTransformation(this.wrapped, bitmap0);
        return resource0;
    }
