...
public class GifDrawable extends Drawable implements Animatable, FrameCallback {
    static final class GifState extends Drawable.ConstantState {
        ...
        public GifState(GifFrameLoader gifFrameLoader0) {
            this.frameLoader = gifFrameLoader0;
        }
    ...
    public GifDrawable(Context context0, GifDecoder gifDecoder0, Transformation transformation0, int v, int v1, Bitmap bitmap0) {
        this(new GifState(new GifFrameLoader(Glide.get(context0), gifDecoder0, v, v1, transformation0, bitmap0)));
    }
    ...
    public GifDrawable(GifState gifDrawable$GifState0) {
        this.isVisible = true;
        this.maxLoopCount = -1;
        this.state = (GifState)Preconditions.checkNotNull(gifDrawable$GifState0);
    }

    public GifDrawable(GifFrameLoader gifFrameLoader0, Paint paint0) {
        this(new GifState(gifFrameLoader0));
        this.paint = paint0;
    }
