...
final class zzbm extends zzk {
    ...
    public zzbm(WeakReference weakReference0, ResultReceiver resultReceiver0, zzbl zzbl0) {
    ...
    public final void zza(Bundle bundle0) {
        ...
        try {
            ...
            bundle2.putString("INTERNAL_LOG_ERROR_ADDITIONAL_DETAILS", runtimeException0.getClass().getName() + ": " + zzab.zzb(runtimeException0.getMessage()));
