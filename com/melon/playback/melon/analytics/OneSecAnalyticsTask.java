...
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B\u000F\u0012\u0006\u0010\u0003\u001A\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"Lcom/melon/playback/melon/analytics/OneSecAnalyticsTask;", "Lcom/melon/playback/melon/analytics/AnalyticsTask;", "Landroid/content/Context;", "context", "<init>", "(Landroid/content/Context;)V", "app_playstoreProdRelease"}, k = 1, mv = {2, 2, 0}, xi = 0x30)
public final class OneSecAnalyticsTask extends AnalyticsTask {
    public OneSecAnalyticsTask(@NotNull Context context0) {
    ...
    public final void c(w w0, z0 z00) {
        ...
        ReportService.sendLogging(new OneSecStreamingAnalysisReq(this.a, streamingAnalysisReq$ParamInfo0));
        m0.o.invoke();
    }
    ...
    public final boolean d(w w0) {
        return w0.b.b.length() != 0 && !w0.b.c.equals(CType.LIVE);
    }
}
