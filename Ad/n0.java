...
public final class n0 extends i implements n {
    ...
    public n0(q0 q00, String s, String s1, String s2, Continuation continuation0) {
        this.w = q00;
        this.B = s;
        this.D = s1;
        this.E = s2;
    ...
    public final Continuation create(Object object0, Continuation continuation0) {
        return new n0(this.w, this.B, this.D, this.E, continuation0);
    }
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.r) {
            case 0: {
                d5.n.D(object0);
                Deferred deferred0 = BuildersKt__Builders_commonKt.async$default(f0.h(q00), null, null, new m0(q00, this.B, this.D, this.E, null), 3, null);
                this.r = 1;
        ...
        if(((f)object0) instanceof e) {
            RESPONSE ageSongChartListRes$RESPONSE0 = ((AgeSongChartListRes)((e)(((f)object0))).a).response;
            if(ageSongChartListRes$RESPONSE0 == null) {
                arrayList0 = w.a;
            }
            else {
                arrayList0 = ageSongChartListRes$RESPONSE0.chartList;
                if(arrayList0 == null) {
                    arrayList0 = w.a;
                }
            }
