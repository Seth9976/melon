...
import com.iloen.melon.net.v5x.response.DailySongChartListRes.RESPONSE;
...
public final class p0 extends i implements n {
    ...
    public p0(q0 q00, String s, Continuation continuation0) {
        this.w = q00;
        this.B = s;
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.r) {
            case 0: {
                d5.n.D(object0);
                Deferred deferred0 = BuildersKt__Builders_commonKt.async$default(f0.h(q00), null, null, new o0(q00, this.B, null), 3, null);
                this.r = 1;
        ...
        if(((f)object0) instanceof e) {
            RESPONSE dailySongChartListRes$RESPONSE0 = ((DailySongChartListRes)((e)(((f)object0))).a).response;
            if(dailySongChartListRes$RESPONSE0 == null) {
                arrayList0 = w.a;
            }
            else {
                arrayList0 = dailySongChartListRes$RESPONSE0.chartList;
                if(arrayList0 == null) {
                    arrayList0 = w.a;
                }
            }
