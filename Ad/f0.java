...
import Na.e;
import Na.f;
import com.iloen.melon.net.v6x.response.ChartHot100ListRes.RESPONSE;
...
public final class f0 extends i implements n {
    ...
    public f0(q0 q00, String s, Continuation continuation0) {
        this.w = q00;
        this.B = s;
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.r) {
            case 0: {
                d5.n.D(object0);
                Deferred deferred0 = BuildersKt__Builders_commonKt.async$default(androidx.lifecycle.f0.h(q00), null, null, new e0(q00, this.B, null), 3, null);
                this.r = 1;
        ...
        if(((f)object0) instanceof e) {
            RESPONSE chartHot100ListRes$RESPONSE0 = ((ChartHot100ListRes)((e)(((f)object0))).a).response;
            if(chartHot100ListRes$RESPONSE0 == null) {
                arrayList0 = w.a;
            }
            else {
                arrayList0 = chartHot100ListRes$RESPONSE0.songList;
                if(arrayList0 == null) {
                    arrayList0 = w.a;
                }
            }
