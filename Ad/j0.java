...
import com.iloen.melon.net.v5x.response.ChartTopWeeklySongChartListRes.RESPONSE;
...
public final class j0 extends i implements n {
    ...
    public j0(q0 q00, Continuation continuation0) {
        this.w = q00;
    ...
    public final Object invokeSuspend(Object object0) {
        ...
        switch(this.r) {
            case 0: {
                d5.n.D(object0);
                Deferred deferred0 = BuildersKt__Builders_commonKt.async$default(f0.h(q00), null, null, new i0(q00, null), 3, null);
                this.r = 1;
        ...
        if(((f)object0) instanceof e) {
            RESPONSE chartTopWeeklySongChartListRes$RESPONSE0 = ((ChartTopWeeklySongChartListRes)((e)(((f)object0))).a).response;
            if(chartTopWeeklySongChartListRes$RESPONSE0 == null) {
                arrayList0 = w.a;
            }
            else {
                arrayList0 = chartTopWeeklySongChartListRes$RESPONSE0.chartList;
                if(arrayList0 == null) {
                    arrayList0 = w.a;
                }
            }
