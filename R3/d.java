...
public final class d {
    ...
    public d(long v, boolean z, boolean z1, boolean z2, ArrayList arrayList0, long v1, boolean z3, long v2, int v3, int v4, int v5) {
        this.a = v;
        this.b = z;
        this.c = z1;
        this.d = z2;
    ...
    public d(Parcel parcel0) {
        ...
        for(int v1 = 0; v1 < v; ++v1) {
            arrayList0.add(new c(parcel0.readInt(), parcel0.readLong()));
        }
        this.f = Collections.unmodifiableList(arrayList0);
