...
public final class b0 implements a {
    ...
    public b0(LinearLayout linearLayout0, LinearLayout linearLayout1, MainTabTitleView mainTabTitleView0) {
        this.a = linearLayout0;
        this.b = linearLayout1;
        this.c = mainTabTitleView0;
    }

    public static b0 a(LayoutInflater layoutInflater0, ViewGroup viewGroup0) {
        View view0 = layoutInflater0.inflate(0x7F0D0219, viewGroup0, false);  // layout:detail_item_magazine
        ...
        if(linearLayout0 != null) {
            ...
            if(mainTabTitleView0 != null) {
                return new b0(((LinearLayout)view0), linearLayout0, mainTabTitleView0);
            }
        }
