...
public final class l extends m {
    ...
    public final byte[] G(int v) {
        ...
        int v3 = v1 + v2 + v;
        if(v3 - 0x7FFFFFFF > 0) {
            throw new F("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");  // 初始化器: Ljava/io/IOException;-><init>(Ljava/lang/String;)V
        }
        int v4 = this.j;
        if(v3 <= v4) {
            int v5 = this.e - v2;
    ...
    public final void O(int v) {
        if(!this.Q(v)) {
            throw v <= 0x7FFFFFFF - this.i - this.g ? F.e() : new F("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");  // 初始化器: Ljava/io/IOException;-><init>(Ljava/lang/String;)V
        }
    }
    ...
    public final i k() {
        ...
        if(arr_b1 != null) {
            return j.d(arr_b1, 0, arr_b1.length);
        }
        int v2 = this.g;
        int v3 = this.e - v2;
        this.i += this.e;
    ...
    public final String y() {
        ...
        if(v > 0) {
            int v1 = this.g;
            if(v <= this.e - v1) {
                String s = new String(arr_b, v1, v, D.a);
                this.g += v;
                return s;
            }
        }
        ...
        if(v <= this.e) {
            this.O(v);
            String s1 = new String(arr_b, this.g, v, D.a);
            this.g += v;
            return s1;
        }
        return new String(this.F(v), D.a);
    }
