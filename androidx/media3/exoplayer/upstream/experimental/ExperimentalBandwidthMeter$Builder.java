...
public final class ExperimentalBandwidthMeter.Builder {
    public ExperimentalBandwidthMeter.Builder(Context context0) {
        ...
        hashMap0.put(2, ((Long)a.a.get(arr_v[0])));
        hashMap0.put(3, ((Long)a.b.get(arr_v[1])));
        hashMap0.put(4, ((Long)a.c.get(arr_v[2])));
        hashMap0.put(5, ((Long)a.d.get(arr_v[3])));
        hashMap0.put(10, ((Long)a.e.get(arr_v[4])));
        hashMap0.put(9, ((Long)a.f.get(arr_v[5])));
        hashMap0.put(7, ((Long)a.a.get(arr_v[0])));
        new b();
        new ArrayList();
        new ArrayDeque();
