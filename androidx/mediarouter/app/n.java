...
public final class n extends AsyncTask {
    ...
    public int c;
    public long d;
    public final MediaRouteControllerDialog e;

    public n(MediaRouteControllerDialog mediaRouteControllerDialog0) {
        this.e = mediaRouteControllerDialog0;
        super();
        Uri uri0 = null;
        Bitmap bitmap0 = mediaRouteControllerDialog0.r0 == null ? null : mediaRouteControllerDialog0.r0.getIconBitmap();
        if(bitmap0 != null && bitmap0.isRecycled()) {
            Log.w("MediaRouteCtrlDialog", "Can\'t fetch the given art bitmap because it\'s already recycled.");
            bitmap0 = null;
        }
        this.a = bitmap0;
        MediaDescriptionCompat mediaDescriptionCompat0 = mediaRouteControllerDialog0.r0;
    ...
    public final BufferedInputStream a(Uri uri0) {
        ...
        if(!"android.resource".equals(s) && !"content".equals(s) && !"file".equals(s)) {
            ...
            uRLConnection0.setConnectTimeout(MediaRouteControllerDialog.L0);
            uRLConnection0.setReadTimeout(MediaRouteControllerDialog.L0);
            inputStream0 = uRLConnection0.getInputStream();
            return inputStream0 == null ? null : new BufferedInputStream(inputStream0);
        }
        inputStream0 = this.e.j.getContentResolver().openInputStream(uri0);
        return inputStream0 == null ? null : new BufferedInputStream(inputStream0);
    }
                    ...
                    try {
                        ...
                        label_19:
                            ...
                            label_26:
                                ...
                                int v1 = this.e.i(bitmapFactory$Options0.outWidth, bitmapFactory$Options0.outHeight);
    ...
    public final void onPostExecute(Object object0) {
        MediaRouteControllerDialog mediaRouteControllerDialog0 = this.e;
        mediaRouteControllerDialog0.s0 = null;
        Bitmap bitmap0 = this.a;
        boolean z = Objects.equals(mediaRouteControllerDialog0.t0, bitmap0);
        Uri uri0 = this.b;
        if(z && Objects.equals(mediaRouteControllerDialog0.u0, uri0)) {
            return;
        }
        mediaRouteControllerDialog0.t0 = bitmap0;
        mediaRouteControllerDialog0.w0 = (Bitmap)object0;
        mediaRouteControllerDialog0.u0 = uri0;
        mediaRouteControllerDialog0.x0 = this.c;
        boolean z1 = true;
        mediaRouteControllerDialog0.v0 = true;
        if(SystemClock.uptimeMillis() - this.d <= 120L) {
            z1 = false;
        }
        mediaRouteControllerDialog0.n(z1);
    }
