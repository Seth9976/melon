...
@Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0007\n\u0000\bÁ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001A\u00020\u00042\u0006\u0010\u0005\u001A\u00020\u00062\u0006\u0010\u0007\u001A\u00020\bH\u0016J\u0018\u0010\u0003\u001A\u00020\u00042\u0006\u0010\t\u001A\u00020\n2\u0006\u0010\u0007\u001A\u00020\bH\u0016J\u0018\u0010\u000B\u001A\u00020\u00042\u0006\u0010\t\u001A\u00020\n2\u0006\u0010\u0007\u001A\u00020\bH\u0016J\u0018\u0010\f\u001A\u00020\u00042\u0006\u0010\r\u001A\u00020\u000E2\u0006\u0010\u000F\u001A\u00020\u0010H\u0016¨\u0006\u0011"}, d2 = {"Landroidx/window/layout/util/WindowMetricsCompatHelperApi34Impl;", "Landroidx/window/layout/util/WindowMetricsCompatHelper;", "()V", "currentWindowMetrics", "Landroidx/window/layout/WindowMetrics;", "activity", "Landroid/app/Activity;", "densityCompatHelper", "Landroidx/window/layout/util/DensityCompatHelper;", "context", "Landroid/content/Context;", "maximumWindowMetrics", "translateWindowMetrics", "windowMetrics", "Landroid/view/WindowMetrics;", "density", "", "window_release"}, k = 1, mv = {1, 9, 0}, xi = 0x30)
public final class WindowMetricsCompatHelperApi34Impl implements WindowMetricsCompatHelper {
    @NotNull
    public static final WindowMetricsCompatHelperApi34Impl INSTANCE;

    static {
        WindowMetricsCompatHelperApi34Impl.INSTANCE = new WindowMetricsCompatHelperApi34Impl();
    }
    ...
    public WindowMetrics currentWindowMetrics(@NotNull Activity activity0, @NotNull DensityCompatHelper densityCompatHelper0) {
        ...
        return WindowMetricsCompatHelperApi30Impl.INSTANCE.currentWindowMetrics(activity0, densityCompatHelper0);
    }
    ...
    public WindowMetrics currentWindowMetrics(@NotNull Context context0, @NotNull DensityCompatHelper densityCompatHelper0) {
        ...
        q.f(rect0, "getBounds(...)");
        return new WindowMetrics(rect0, windowManager0.getCurrentWindowMetrics().getDensity());
    }
    ...
    public WindowMetrics maximumWindowMetrics(@NotNull Context context0, @NotNull DensityCompatHelper densityCompatHelper0) {
        q.g(context0, "context");
        q.g(densityCompatHelper0, "densityCompatHelper");
        return WindowMetricsCompatHelperApi30Impl.INSTANCE.maximumWindowMetrics(context0, densityCompatHelper0);
    }
    ...
    public WindowMetrics translateWindowMetrics(@NotNull android.view.WindowMetrics windowMetrics0, float f) {
        ...
        q.f(rect0, "getBounds(...)");
        return new WindowMetrics(rect0, windowMetrics0.getDensity());
    }
}
