...
public final class X extends b implements RandomAccess {
    public Object[] b;
    public int c;
    public static final X d;

    static {
        X.d = new X(new Object[0], 0, false);
    }

    public X(Object[] arr_object, int v, boolean z) {
        this.a = z;
        this.b = arr_object;
        this.c = v;
    }
    ...
    public final X e(int v) {
        if(v < this.c) {
            throw new IllegalArgumentException();
        }
        return new X(Arrays.copyOf(this.b, v), this.c, true);
    }
