...
public final class l implements b {
    ...
    public l(HashMap hashMap0, c c0) {
        q.g(c0, "equalityAxioms");
        super();
        this.a = hashMap0;
        this.b = c0;
    }
    ...
    @Override  // If.b
    public final Kf.c D(B b0) {
        return g.e(this, b0);
    }

    @Override  // If.b
    public final boolean E(Kf.c c0) {
        return g.J(c0);
    }
    ...
    @Override  // If.b
    public final Kf.b Y(Kf.c c0) {
        return g.k(c0);
    }

    @Override  // If.b
    public final i Z(Kf.c c0) {
        return g.W(c0);
    }
    ...
    public final boolean e(h h0, h h1) {
        q.g(h0, "c1");
        q.g(h1, "c2");
        if(!(h0 instanceof M) || !(h1 instanceof M)) {
            throw new IllegalArgumentException("Failed requirement.");
        }
        if(!g.b(h0, h1) && !this.b.d(((M)h0), ((M)h1))) {
            Map map0 = this.a;
            if(map0 != null) {
                M m0 = (M)map0.get(((M)h0));
                M m1 = (M)map0.get(((M)h1));
                return m0 != null && m0.equals(((M)h1)) || m1 != null && m1.equals(((M)h0));
            }
            return false;
        }
        return true;
    ...
    @Override  // If.b
    public final boolean m0(Kf.c c0) {
        q.g(c0, "$receiver");
    ...
    @Override  // If.b
    public final a0 p(Kf.c c0) {
        return g.O(c0);
    }

    public final L p0() {
        return new L(true, true, this, If.e.a, If.f.a);
    }
    ...
    public final a0 t(ArrayList arrayList0) {
        ...
        switch(arrayList0.size()) {
            ...
            default: {
                ...
                if(z) {
                    return Jf.l.c(k.N, new String[]{arrayList0.toString()});
                }
                t t0 = t.a;
                if(!z1) {
